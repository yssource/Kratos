...
//
//  Main authors:    Iñigo Lopez and Michael Andre, https://github.com/msandre
//

#if !defined(KRATOS_ADJOINT_STEADY_POTENTIAL_SCHEME)
#define KRATOS_ADJOINT_STEADY_POTENTIAL_SCHEME
...
class AdjointSteadyPotentialScheme : public Scheme<TSparseSpace, TDenseSpace>
{
public:
    ///@name Type Definitions
    ///@{

    KRATOS_CLASS_POINTER_DEFINITION(AdjointSteadyPotentialScheme);
    ...
    /// Constructor.
    AdjointSteadyPotentialScheme(Parameters& rParameters, ResponseFunction::Pointer pResponseFunction)
    ...
    /// Destructor.
    ~AdjointSteadyPotentialScheme() override
    {
    }
...
#pragma omp parallel
                                      ...
                                      ProcessInfo& rCurrentProcessInfo) override
    {
        ...
        // Calculate transposed gradient of response function on element w.r.t. potential (primal variable)
...
#endif /* KRATOS_ADJOINT_STEADY_POTENTIAL_SCHEME defined */
