...
template<   class TSparseSpace,
            class TDenseSpace >
class AdjointVelPrCriteria : public ConvergenceCriteria< TSparseSpace, TDenseSpace >
{
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION( AdjointVelPrCriteria );
     ...
     */
    AdjointVelPrCriteria(  TDataType AdjointVariableRatioTolerance,
