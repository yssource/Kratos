...
public:
    ...
    {
        KRATOS_TRY;
<<<<<<< HEAD:applications/ChimeraApplication/custom_processes/calculate_signed_distance_to_2d_condition_skin_process.h
...
>>>>>>> 9e55d326648959addeb79b63ebc6d3f2c99a45c6:applications/ChimeraApplication/custom_processes/calculate_signed_distance_to_2d_skin_process.h
...
*/
       ...
       double mag_cd,gk,hk,kk;
        ...
        if (kk < epsilon) {     // ray is parallel to the struc line segment
            if (mag_cd == 0)                // ray is coincident with struc edge
                return 2;
            else return 0;             // ray disjoint from struc edge
        }
