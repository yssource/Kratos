...
# other imports
from KratosMultiphysics.MeshMovingApplication.ale_chimera_solver import AleChimeraSolver
import KratosMultiphysics.ChimeraApplication.python_solvers_wrapper_fluid_chimera as fluid_solvers_wrapper


def CreateSolver(model, solver_settings, parallelism):
    return NavierStokesAleFluidSolver(model, solver_settings, parallelism)

class NavierStokesAleFluidSolver(AleChimeraSolver):
