...
#import KratosMultiphysics.StructuralApplication as KratosStructure
...
def CreateSolver(main_model_part, custom_settings):
    return StaticMechanicalSolverChimera(main_model_part, custom_settings)

class StaticMechanicalSolverChimera(solid_mechanics_solver.MechanicalSolver):
    ...
    def __init__(self, main_model_part, custom_settings): 
        ...
        {
            "solver_type": "solid_mechanics_static_solver_chimera",
            "echo_level": 0,
            "buffer_size": 2,
            "implementation": "MPC",
