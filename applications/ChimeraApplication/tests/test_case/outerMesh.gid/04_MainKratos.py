...
for patchName, patch_model_part in patchNameModelPartMap.items():
        backGround_model_part.CreateSubModelPart("test")
        testMP = backGround_model_part.GetSubModelPart("test")
        testMP.Nodes = patch_model_part.Nodes
        testMP.Elements = patch_model_part.Elements
        testMP.Conditions = patch_model_part.Conditions
#####################################
