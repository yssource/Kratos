...
KRATOS_CREATE_VARIABLE(double, CP)
KRATOS_CREATE_VARIABLE(double, GAMMA)

// Free stream magnitudes
KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(VELOCITY_INFINITY)
KRATOS_CREATE_VARIABLE(double, DENSITY_INFINITY)
KRATOS_CREATE_VARIABLE(double, MACH_INFINITY)
KRATOS_CREATE_VARIABLE(double, PRESSURE_INFINITY)
...
KRATOS_CREATE_VARIABLE(int, ECHO_LEVEL)
