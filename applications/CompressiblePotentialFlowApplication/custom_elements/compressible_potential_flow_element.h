...
public:
        ...
        ProcessInfo& rCurrentProcessInfo) override
    {
        ...
        GeometryUtils::CalculateGeometryData(r_geom, data.DN_DX, data.N, data.vol);

        //gather nodal data
        for(unsigned int i=0; i<NumNodes; i++)
        {
            data.phis[i] = r_geom[i].FastGetSolutionStepValue(POSITIVE_FACE_PRESSURE);
        }
        ...
        noalias(rLeftHandSideMatrix) = data.vol * prod(data.DN_DX, trans(data.DN_DX));
        ...
        //     // if (this->Is(THERMAL))
        //     // {
        //     //     // std::cout << "\n\n THERMAL ELEMENT " << this->Id() << std::endl;
        ...
        //     //     // std::cout << "\n lhs_penalty = " << lhs_penalty << std::endl;
        //     //     // std::cout << "\n rLeftHandSideMatrix = " << rLeftHandSideMatrix << std::endl;
        //     // }
        ...
        //     //     std::cout << "\n\n TEST "  << std::endl;
        //     //     std::cout << "\n\n rLeftHandSideMatrix = " << rLeftHandSideMatrix << std::endl;
        //     //     //rLeftHandSideMatrix(2,2) += 1.000001;
        //     //     std::cout << "\n\n rLeftHandSideMatrix = " << rLeftHandSideMatrix << std::endl;
        //     //     std::cout << "\n\n rLeftHandSideMatrix = " << rLeftHandSideMatrix(2,2) << std::endl;
        //     // }
        // }
...
//                     else
//                     {
//                         std::cout << "WAKE KUTTA PENALTY ELEMENT " << this->Id()  << std::endl;
//                         for (unsigned int i = 0; i < NumNodes; ++i)
//                         {
//                             for (unsigned int j = 0; j < NumNodes; ++j)
//                             {
...
//    }
    ...
    {
        std::cout << " ENTERING CALCULATE RIGHTHANDSIDE "  << std::endl;
        //TODO: improve speed
        Matrix tmp;
