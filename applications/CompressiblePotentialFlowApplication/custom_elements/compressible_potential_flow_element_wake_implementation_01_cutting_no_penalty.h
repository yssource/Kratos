...
#if !defined(KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_01_H_INCLUDED)
#define KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_01_H_INCLUDED
...
class CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty : public Element
{
  public:
    ...
    /// Pointer definition of CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty
    KRATOS_CLASS_POINTER_DEFINITION(CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty);
     ...
     * Constructor.
     */
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(IndexType NewId = 0){};

    /**
     * Constructor using an array of nodes
     */
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(IndexType NewId, const NodesArrayType &ThisNodes) : Element(NewId, ThisNodes){};

    /**
     * Constructor using Geometry
     */
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(IndexType NewId, GeometryType::Pointer pGeometry) : Element(NewId, pGeometry){};

    /**
     * Constructor using Properties
     */
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element(NewId, pGeometry, pProperties){};

    /**
     * Copy Constructor
     */
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty const &rOther){};

    /**
     * Destructor
     */
    ~CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty() override{};
    ...
    /// Assignment operator.
    CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty &operator=(CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty const &rOther)
    {
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(NewId, GetGeometry().Create(ThisNodes), pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(NewId, pGeom, pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
        KRATOS_CATCH("");
    }
    ...
    int Check(const ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->Id() < 1)
        {
            KRATOS_THROW_ERROR(std::logic_error, "CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty found with Id 0 or negative", "")
        }

        if (this->GetGeometry().Area() <= 0)
        {
            std::cout << "error on CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty -> " << this->Id() << std::endl;
    ...
    std::string Info() const override
    {
        ...
        buffer << "CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty #" << Id();
    }
...
}; // Class CompressiblePotentialFlowElementWakeImplementation01CuttingNoPenalty
