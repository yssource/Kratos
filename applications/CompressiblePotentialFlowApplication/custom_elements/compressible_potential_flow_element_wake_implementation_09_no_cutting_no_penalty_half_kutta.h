...
#if !defined(KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_09_H_INCLUDED)
#define KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_09_H_INCLUDED
...
class CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta : public Element
{
  public:
    ...
    /// Pointer definition of CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta
    KRATOS_CLASS_POINTER_DEFINITION(CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta);
     ...
     * Constructor.
     */
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(IndexType NewId = 0){};

    /**
     * Constructor using an array of nodes
     */
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(IndexType NewId, const NodesArrayType &ThisNodes) : Element(NewId, ThisNodes){};

    /**
     * Constructor using Geometry
     */
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(IndexType NewId, GeometryType::Pointer pGeometry) : Element(NewId, pGeometry){};

    /**
     * Constructor using Properties
     */
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element(NewId, pGeometry, pProperties){};

    /**
     * Copy Constructor
     */
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta const &rOther){};

    /**
     * Destructor
     */
    ~CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta() override{};
    ...
    /// Assignment operator.
    CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta &operator=(CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta const &rOther)
    {
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(NewId, GetGeometry().Create(ThisNodes), pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(NewId, pGeom, pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
        KRATOS_CATCH("");
    }
        ...
        else //it is a wake element
        {
            ...
            if (this->Is(STRUCTURE))
            {
                ...
                for (unsigned int i = 0; i < NumNodes; ++i)
                {
                    ...
                    {
                        std::cout << "entering here only once" << std::endl;
                        for (unsigned int j = 0; j < NumNodes; ++j)
    ...
    int Check(const ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->Id() < 1)
        {
            KRATOS_THROW_ERROR(std::logic_error, "CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta found with Id 0 or negative", "")
        }

        if (this->GetGeometry().Area() <= 0)
        {
            std::cout << "error on CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta -> " << this->Id() << std::endl;
    ...
    std::string Info() const override
    {
        ...
        buffer << "CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta #" << Id();
    }
...
}; // Class CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta
