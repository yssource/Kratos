...
#if !defined(KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_13_H_INCLUDED)
#define KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_13_H_INCLUDED
...
class CompressiblePotentialFlowElementWakeImplementation13NoTe : public Element
{
  public:
    ...
    /// Pointer definition of CompressiblePotentialFlowElementWakeImplementation13NoTe
    KRATOS_CLASS_POINTER_DEFINITION(CompressiblePotentialFlowElementWakeImplementation13NoTe);
     ...
     * Constructor.
     */
    CompressiblePotentialFlowElementWakeImplementation13NoTe(IndexType NewId = 0){};

    /**
     * Constructor using an array of nodes
     */
    CompressiblePotentialFlowElementWakeImplementation13NoTe(IndexType NewId, const NodesArrayType &ThisNodes) : Element(NewId, ThisNodes){};

    /**
     * Constructor using Geometry
     */
    CompressiblePotentialFlowElementWakeImplementation13NoTe(IndexType NewId, GeometryType::Pointer pGeometry) : Element(NewId, pGeometry){};

    /**
     * Constructor using Properties
     */
    CompressiblePotentialFlowElementWakeImplementation13NoTe(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element(NewId, pGeometry, pProperties){};

    /**
     * Copy Constructor
     */
    CompressiblePotentialFlowElementWakeImplementation13NoTe(CompressiblePotentialFlowElementWakeImplementation13NoTe const &rOther){};

    /**
     * Destructor
     */
    ~CompressiblePotentialFlowElementWakeImplementation13NoTe() override{};
    ...
    /// Assignment operator.
    CompressiblePotentialFlowElementWakeImplementation13NoTe &operator=(CompressiblePotentialFlowElementWakeImplementation13NoTe const &rOther)
    {
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation13NoTe(NewId, GetGeometry().Create(ThisNodes), pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation13NoTe(NewId, pGeom, pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation13NoTe(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
        KRATOS_CATCH("");
    }
        ...
        ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        else //it is a wake element
        {
            ...
            {   //Looping over columngs
                ...
                if (data.distances[i] < 0.0 && !GetGeometry()[i].FastGetSolutionStepValue(TRAILING_EDGE))
                ...
                else if(data.distances[i] > 0.0 && !GetGeometry()[i].FastGetSolutionStepValue(TRAILING_EDGE))
    ...
    int Check(const ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->Id() < 1)
        {
            KRATOS_THROW_ERROR(std::logic_error, "CompressiblePotentialFlowElementWakeImplementation13NoTe found with Id 0 or negative", "")
        }

        if (this->GetGeometry().Area() <= 0)
        {
            std::cout << "error on CompressiblePotentialFlowElementWakeImplementation13NoTe -> " << this->Id() << std::endl;
    ...
    std::string Info() const override
    {
        ...
        buffer << "CompressiblePotentialFlowElementWakeImplementation13NoTe #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "CompressiblePotentialFlowElementWakeImplementation13NoTe #" << Id();
    }
...
}; // Class CompressiblePotentialFlowElementWakeImplementation13NoTe
