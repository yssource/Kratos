...
#if !defined(KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_19_H_INCLUDED)
#define KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_19_H_INCLUDED
...
class CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity : public Element
{
  public:
    ...
    /// Pointer definition of CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity
    KRATOS_CLASS_POINTER_DEFINITION(CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity);
     ...
     * Constructor.
     */
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(IndexType NewId = 0){};

    /**
     * Constructor using an array of nodes
     */
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(IndexType NewId, const NodesArrayType &ThisNodes) : Element(NewId, ThisNodes){};

    /**
     * Constructor using Geometry
     */
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(IndexType NewId, GeometryType::Pointer pGeometry) : Element(NewId, pGeometry){};

    /**
     * Constructor using Properties
     */
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element(NewId, pGeometry, pProperties){};

    /**
     * Copy Constructor
     */
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity const &rOther){};

    /**
     * Destructor
     */
    ~CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity() override{};
    ...
    /// Assignment operator.
    CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity &operator=(CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity const &rOther)
    {
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(NewId, GetGeometry().Create(ThisNodes), pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(NewId, pGeom, pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
        KRATOS_CATCH("");
    }
        ...
        ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->IsNot(MARKER)) //normal element (non-wake) - eventually an embedded
        {
            ...
            if(this->GetValue(ALL_TRAILING_EDGE) == 0)
            {
                ComputeLHSGaussPointContribution(data.vol, rLeftHandSideMatrix, data);
            }
            else
            {
                if(this->GetValue(ZERO_VELOCITY_CONDITION) != 0)
                {
                    ComputeLHSGaussPointContribution(data.vol, rLeftHandSideMatrix, data);
                }
                else
    ...
    int Check(const ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->Id() < 1)
        {
            KRATOS_THROW_ERROR(std::logic_error, "CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity found with Id 0 or negative", "")
        }

        if (this->GetGeometry().Area() <= 0)
        {
            std::cout << "error on CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity -> " << this->Id() << std::endl;
    ...
    std::string Info() const override
    {
        ...
        buffer << "CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity #" << Id();
    }
...
}; // Class CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity
