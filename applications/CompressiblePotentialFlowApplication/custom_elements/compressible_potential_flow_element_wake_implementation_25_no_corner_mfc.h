...
#if !defined(KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_25_H_INCLUDED)
#define KRATOS_COMPRESSIBLE_POTENTIAL_FLOW_ELEMENT_25_H_INCLUDED
...
class CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc : public Element
{
  public:
    ...
    /// Pointer definition of CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc
    KRATOS_CLASS_POINTER_DEFINITION(CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc);
     ...
     * Constructor.
     */
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(IndexType NewId = 0){};

    /**
     * Constructor using an array of nodes
     */
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(IndexType NewId, const NodesArrayType &ThisNodes) : Element(NewId, ThisNodes){};

    /**
     * Constructor using Geometry
     */
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(IndexType NewId, GeometryType::Pointer pGeometry) : Element(NewId, pGeometry){};

    /**
     * Constructor using Properties
     */
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties) : Element(NewId, pGeometry, pProperties){};

    /**
     * Copy Constructor
     */
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc const &rOther){};

    /**
     * Destructor
     */
    ~CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc() override{};
    ...
    /// Assignment operator.
    CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc &operator=(CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc const &rOther)
    {
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(NewId, GetGeometry().Create(ThisNodes), pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(NewId, pGeom, pProperties));
        KRATOS_CATCH("");
    }
    ...
    {
        KRATOS_TRY
        return Element::Pointer(new CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc(NewId, GetGeometry().Create(ThisNodes), pGetProperties()));
        KRATOS_CATCH("");
    }
    ...
    void GetDofList(DofsVectorType &rElementalDofList, ProcessInfo &CurrentProcessInfo) override
    {
        if (this->IsNot(MARKER)) //normal element
        {
            ...
            else
            {
                ...
                std::cout << "Getting Dofs Example = "<< rElementalDofList << std::endl;
            }
        }
        else //wake element
        {
    ...
    int Check(const ProcessInfo &rCurrentProcessInfo) override
    {
        ...
        if (this->Id() < 1)
        {
            KRATOS_THROW_ERROR(std::logic_error, "CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc found with Id 0 or negative", "")
        }

        if (this->GetGeometry().Area() <= 0)
        {
            std::cout << "error on CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc -> " << this->Id() << std::endl;
    ...
    std::string Info() const override
    {
        ...
        buffer << "CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc #" << Id();
    }
...
}; // Class CompressiblePotentialFlowElementWakeImplementation25NoCornerMfc
