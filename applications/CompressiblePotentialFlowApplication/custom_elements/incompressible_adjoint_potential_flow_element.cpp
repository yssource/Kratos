...
namespace Kratos
{
    ...
    template <class TPrimalElement>
    void AdjointIncompressiblePotentialFlowElement<TPrimalElement>::CalculateSensitivityMatrix(const Variable<double>& rDesignVariable,
                                    Matrix& rOutput,
                                    const ProcessInfo& rCurrentProcessInfo)
    {
        KRATOS_TRY;
    ...
    template class AdjointIncompressiblePotentialFlowElement<EmbeddedIncompressiblePotentialFlowElement<2,3>>;
} // namespace Kratos.
