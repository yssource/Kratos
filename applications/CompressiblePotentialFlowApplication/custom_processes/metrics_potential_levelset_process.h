...
/**
 * @class ComputePotentialLevelSetSolMetricProcess
 * @ingroup MeshingApplication
 * @brief This class is can be used to compute the metrics of the model part with a level set approach
 * @author Vicente Mataix Ferrandiz
 */
template<SizeType TDim>
class KRATOS_API(MESHING_APPLICATION) ComputePotentialLevelSetSolMetricProcess
    : public Process
{
public:
    ...
    /// Pointer definition of ComputePotentialLevelSetSolMetricProcess
    KRATOS_CLASS_POINTER_DEFINITION(ComputePotentialLevelSetSolMetricProcess);
     ...
     */
    ComputePotentialLevelSetSolMetricProcess(
    ...
    /// Destructor.
    ~ComputePotentialLevelSetSolMetricProcess() override = default;
    ...
    {
        return "ComputePotentialLevelSetSolMetricProcess";
    }

    /// Print information about this object.
    void PrintInfo(std::ostream& rOStream) const override
    {
        rOStream << "ComputePotentialLevelSetSolMetricProcess";
    }
...
private:
    ...
    /// Assignment operator.
    ComputePotentialLevelSetSolMetricProcess& operator=(ComputePotentialLevelSetSolMetricProcess const& rOther)
    {
        return *this;
    };

    /// Copy constructor.
    //ComputePotentialLevelSetSolMetricProcess(ComputePotentialLevelSetSolMetricProcess const& rOther);
...
inline std::istream& operator >> (std::istream& rIStream,
                                  ComputePotentialLevelSetSolMetricProcess<TDim>& rThis);

/// output stream function
template<unsigned int TDim>
inline std::ostream& operator << (std::ostream& rOStream,
                                  const ComputePotentialLevelSetSolMetricProcess<TDim>& rThis)
{
