...
PYBIND11_MODULE(KratosCompressiblePotentialFlowApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CP);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DENSITY_INFINITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MACH_INFINITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PRESSURE_INFINITY);
