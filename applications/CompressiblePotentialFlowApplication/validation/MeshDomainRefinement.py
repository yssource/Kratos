...
for k in range(Number_Of_Domains_Size):
    ...
    cp_data_directory_start = work_dir + 'plots/cp/data/DS_' + str(Domain_Length)
    os.mkdir(cp_data_directory_start)

    far_field_data_directory_start = work_dir + 'plots/far_field/data/DS_' + str(Domain_Length)
    os.mkdir(far_field_data_directory_start)

    jump_data_directory_start = work_dir + 'plots/potential_jump/data/DS_' + str(Domain_Length)
    ...
    for j in range(Number_Of_AOAS):
        ...
        mesh_refinement_file_name = work_dir + 'plots/results/mesh_refinement_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        cl_data_directory_name = 'data/cl_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        cl_error_data_directory_name = 'data/cl_error_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        energy_data_directory_name = 'data/energy_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        cd_data_directory_name = 'data/cd_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        condition_data_directory_name = 'data/condition_DS_' + str(Domain_Length) + '_AOA_' + str(AOA)
        loads_output.write_header(work_dir)

        cp_data_directory_start = work_dir + 'plots/cp/data/DS_' + str(Domain_Length) + '/' + 'AOA_' + str(AOA)
        os.mkdir(cp_data_directory_start)

        far_field_data_directory_start = work_dir + 'plots/far_field/data/DS_' + str(Domain_Length) + '/' + 'AOA_' + str(AOA)
        os.mkdir(far_field_data_directory_start)

        jump_data_directory_start = work_dir + 'plots/potential_jump/data/DS_' + str(Domain_Length) + '/' + 'AOA_' + str(AOA)
        os.mkdir(jump_data_directory_start)
        ...
        for i in range(Number_Of_Refinements):
            ...
            cp_data_directory_name = cp_data_directory_start + '/Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
            ...
            jump_data_directory_name = jump_data_directory_start + '/Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
                    AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize)
            ...
            ProjectParameters["boundary_conditions_process_list"][2]["Parameters"]["domain_size"].SetDouble(Domain_Length)
            ...
            problem_name = output_gid_path + 'DS_' + str(Domain_Length) + '/' + 'AOA_' + str(
                    AOA) + '/' + ProjectParameters["problem_data"]["problem_name"].GetString()+ '_Case_' + str(
            ...
            cp_file_name = work_dir + 'plots/cp/plots/cp_Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
            ...
            far_field_x_file_name = work_dir + 'plots/far_field/plots/velocity_x_Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
                    AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.pdf'
            ...
            far_field_y_file_name = work_dir + 'plots/far_field/plots/velocity_y_Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
                    AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.pdf'
            ...
            jump_file_name = work_dir + 'plots/potential_jump/plots/jump_Case_' + str(case) + '_DS_' + str(Domain_Length) + '_AOA_' + str(
                    AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.pdf'
        ...
        cp_final_file_name = work_dir + 'plots/cp/cp_DS_' + str(Domain_Length) + '_AOA_' + str(AOA) + '.pdf'
        merger.write(cp_final_file_name)

        far_field_x_final_file_name = work_dir + 'plots/far_field/far_field_x_DS_' + str(Domain_Length) + '_AOA_' + str(AOA) + '.pdf'
        merger_local_far_field_x.write(far_field_x_final_file_name)

        far_field_y_final_file_name = work_dir + 'plots/far_field/far_field_y_DS_' + str(Domain_Length) + '_AOA_' + str(AOA) + '.pdf'
        merger_local_far_field_y.write(far_field_y_final_file_name)

        jump_final_file_name = work_dir + 'plots/potential_jump/jump_DS_' + str(Domain_Length) + '_AOA_' + str(AOA) + '.pdf'
