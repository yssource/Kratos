...
for j in range(Number_Of_AOAS):
    ...
    for i in range(Number_Of_Refinements):
        ...
        file_name_fluid         = output_salome_path + 'Parts_Parts_Auto1_Case_' + str(case) + '_AOA_' + str(
            AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.dat'
        file_name_far_field     = output_salome_path + 'PotentialWallCondition2D_Far_field_Auto1_Case_' + str(case) + '_AOA_' + str(
            AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.dat'
        file_name_upper_surface = output_salome_path + 'Body2D_UpperSurface_Case_' + str(case) + '_AOA_' + str(
            AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.dat'
        file_name_lower_surface = output_salome_path + 'Body2D_LowerSurface_Case_' + str(case) + '_AOA_' + str(
            AOA) + '_Far_Field_Mesh_Size_' + str(FarField_MeshSize) + '_Airfoil_Mesh_Size_' + str(Airfoil_MeshSize) + '.dat'
