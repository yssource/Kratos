...
WakeProcess=define_wake_process_2d_refinement_wake_implementation_06_no_Kutta_down
...
OUTPUTNAME=wake_implementation_06_no_cutting_no_penalty_no_Kutta_TE_down
