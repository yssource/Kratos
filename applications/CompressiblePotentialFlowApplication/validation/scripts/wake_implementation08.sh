...
Element=CompressiblePotentialFlowElementWakeImplementation03NoCuttingNoPenalty2D3N
...
OUTPUTNAME=wake_implementation_08_no_cutting_no_penalty_one_Kutta_TE_down
