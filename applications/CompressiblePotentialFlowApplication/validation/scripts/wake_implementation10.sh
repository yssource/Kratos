...
Element=CompressiblePotentialFlowElementWakeImplementation09NoCuttingNoPenaltyHalfKutta2D3N
WakeProcess=define_wake_process_2d_refinement_wake_implementation_08_one_Kutta_down
...
OUTPUTNAME=wake_implementation_10_no_cutting_no_penalty_half_Kutta_TE_down
