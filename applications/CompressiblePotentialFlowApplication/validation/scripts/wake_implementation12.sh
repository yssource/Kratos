...
Element=CompressiblePotentialFlowElementWakeImplementation11NoAirfoil2D3N
WakeProcess=define_wake_process_2d_refinement_wake_implementation_12_no_Kutta_no_airfoil_down
...
OUTPUTNAME=wake_implementation_12_no_airfoil_TE_down
