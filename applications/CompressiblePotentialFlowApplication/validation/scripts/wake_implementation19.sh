...
WakeProcess=define_wake_process_2d_refinement_wake_implementation_19_no_corner_one_zero_velocity_te_up
...
OUTPUTNAME=wake_implementation_19_no_corner_one_zero_velocity_TE_down
