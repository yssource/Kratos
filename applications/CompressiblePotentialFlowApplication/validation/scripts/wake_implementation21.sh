...
Element=CompressiblePotentialFlowElementWakeImplementation21NoCornerVariation2D3N
WakeProcess=define_wake_process_2d_refinement_wake_implementation_21_no_corner_variation_te_up
...
OUTPUTNAME=wake_implementation_21_no_corner_variation_TE_up
