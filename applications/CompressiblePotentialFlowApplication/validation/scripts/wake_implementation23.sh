...
Element=CompressiblePotentialFlowElementWakeImplementation19NoCornerZeroVelocity2D3N
WakeProcess=define_wake_process_2d_refinement_wake_implementation_23_no_corner_two_zero_velocity_te_up
...
OUTPUTNAME=wake_implementation_23_no_corner_two_zero_velocity_TE_down
