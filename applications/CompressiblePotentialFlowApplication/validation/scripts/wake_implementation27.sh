...
Element=CompressiblePotentialFlowElementWakeImplementation27NoCornerPenalty2D3N
WakeProcess=define_wake_process_2d_refinement_wake_implementation_27_no_corner_penalty_te_up
...
OUTPUTNAME=wake_implementation_27_no_corner_penalty_TE_up
