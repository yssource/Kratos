...
namespace Kratos
{
  //specific constitutive models variables must be DEFINED here
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, CASM_M )

   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, SPACING_RATIO )
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, SHAPE_PARAMETER )
   ...
   KRATOS_DEFINE_APPLICATION_VARIABLE( CONSTITUTIVE_MODELS_APPLICATION, double, COHESION )
