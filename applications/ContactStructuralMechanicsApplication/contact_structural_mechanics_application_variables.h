...
KRATOS_DEFINE_APPLICATION_VARIABLE( CONTACT_STRUCTURAL_MECHANICS_APPLICATION, double, LOGISTIC_EXPONENT_FACTOR )                     // The factor considered on the logistic function
}
