...
public:
    ...
    std::string Info() const override
    {
        ...
        buffer << "AugmentedLagrangianMethodFrictionlessMortarContactAxisymCondition #" << Id();
        return buffer.str();
    }
    ...
    {
        rOStream << "AugmentedLagrangianMethodFrictionlessMortarContactAxisymCondition #" << Id();
    }
