...
for normalvar in range(normal_combs):
    ...
    for dim, nnodes, nnodes_master in zip(dim_combinations, nnodes_combinations, nnodes_master_combinations):
        ...
        ThresholdValue = custom_sympy_fe_utilities.DefineVector('ThresholdValue', nnodes)
        ...
        ThresholdValue = custom_sympy_fe_utilities.DefineDofDependencyVector(ThresholdValue, u12_var)
        ...
        var_strings, var_strings_subs, var_strings_aux_subs, der_var_strings, der_var_list = custom_sympy_fe_utilities.DefineVariableLists(ThresholdValue, "ThresholdValue", "ThresholdValue", u12_var, var_strings, var_strings_subs, var_strings_aux_subs, der_var_strings, der_var_list, "vector")
        ...
        for dof in reversed(range(len(u12_var))):
            lhs_string = lhs_string.replace("DeltaThresholdValue" + str(dof), "DeltaThresholdValue[" + str(dof)+"]")
