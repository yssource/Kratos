...
KRATOS_CREATE_VARIABLE(double, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_X)
KRATOS_CREATE_VARIABLE(double, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Y)
KRATOS_CREATE_VARIABLE(double, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Z)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(BEAM_PRINCIPAL_MOMENT_OF_INERTIA_X)
    KRATOS_REGISTER_VARIABLE(BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Y)
    KRATOS_REGISTER_VARIABLE(BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Z)
