...
KRATOS_CREATE_VARIABLE(double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
KRATOS_CREATE_VARIABLE(double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
KRATOS_CREATE_VARIABLE(double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
...
void KratosDEMApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
    KRATOS_REGISTER_VARIABLE(FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
    KRATOS_REGISTER_VARIABLE(FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
    // *************** Continuum only END ***************
