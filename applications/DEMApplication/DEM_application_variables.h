...
#define DEM_DETERMINANT_3x3(a0, a1, a2)            (a0[0] * (a1[1] * a2[2] - a1[2] * a2[1]) - a0[1] * (a1[0] * a2[2] - a1[2] * a2[0]) + a0[2] * (a1[0] * a2[1] - a1[1] * a2[0]))
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BEAM_DISTANCE)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BEAM_MASS)
  ...
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
  KRATOS_DEFINE_APPLICATION_VARIABLE(DEM_APPLICATION, double, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
