...
namespace Kratos {
    ...
    void Cluster3D::CreateParticles(ParticleCreatorDestructor* p_creator_destructor, ModelPart& dem_model_part, PropertiesProxy* p_fast_properties, const bool continuum_strategy) {
        ...
        bool contact_info_continuum_element = false;
        ...
        if (GetProperties()[DEM_DISCONTINUUM_CONSTITUTIVE_LAW_NAME] == "DEM_continuum_Conical_damage") contact_info_continuum_element = true;
        ...
        else if (contact_info_continuum_element) ElementNameString= "ContactInfoContinuumSphericParticle3D";
