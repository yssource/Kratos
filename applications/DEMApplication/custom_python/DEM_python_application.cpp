...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_DISTANCE)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_MASS)
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_X)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Y)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, FULL_BEAM_PRINCIPAL_MOMENTS_OF_INERTIA_Z)
