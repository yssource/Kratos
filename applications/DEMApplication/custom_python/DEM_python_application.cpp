...
PYBIND11_MODULE(KratosDEMApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_X)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Y)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BEAM_PRINCIPAL_MOMENT_OF_INERTIA_Z)
