...
#if !defined(KRATOS_EXAQUTE_SANDBOX_APPLICATION_H_INCLUDED )
#define  KRATOS_EXAQUTE_SANDBOX_APPLICATION_H_INCLUDED
...
*/
class KratosExaquteSandboxApplication : public KratosApplication {
public:
    ///@name Type Definitions
    ///@{
    ...
    {
        return "KratosExaquteSandboxApplication";
    }
...
private:
    ...
    /// Assignment operator.
    KratosExaquteSandboxApplication& operator=(KratosExaquteSandboxApplication const& rOther);

    /// Copy constructor.
    KratosExaquteSandboxApplication(KratosExaquteSandboxApplication const& rOther);
...
#endif // KRATOS_EXAQUTE_SANDBOX_APPLICATION_H_INCLUDED  defined
