...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(HEAT_CAPACITY_RATIO);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(REACTION_DENSITY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(REACTION_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(MACH);
