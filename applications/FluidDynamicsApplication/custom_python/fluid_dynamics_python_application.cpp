...
//        KRATOS_REGISTER_IN_PYTHON_VARIABLE(m,C_SMAGORINSKY);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_EIGEN_MIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_EIGEN_MAX);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_EIGEN_MIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_EIGEN_MAX);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_EIGEN_MIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_EIGEN_MAX);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_CUSTOM);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_CUSTOM_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_CUSTOM_EIGEN_MIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_CUSTOM_EIGEN_MAX);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_DIFFUSION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_ENERGY);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_EIGEN_MIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_EIGEN_MAX);

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_PURE_DIFFUSION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_ADJOINT_VECTOR);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_GAUSS_POINT_INTEGRATION_WEIGHT);
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION);
