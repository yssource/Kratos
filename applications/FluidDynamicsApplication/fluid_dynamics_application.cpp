...
void KratosFluidDynamicsApplication::Register() {
    ...
    KRATOS_REGISTER_VARIABLE(ARTIFICIAL_DIFFUSION);
    KRATOS_REGISTER_VARIABLE(VMS_STEADY_TERM_PRIMAL_GRADIENT_MATRIX);
    KRATOS_REGISTER_VARIABLE(VMS_ADJOINT_ENERGY_GENERATION_RATE_MATRIX);
    KRATOS_REGISTER_VARIABLE(VMS_VELOCITY_GRADIENT_TENSOR)
    KRATOS_REGISTER_VARIABLE(ARTIFICIAL_DIFFUSION_MATRIX);
    KRATOS_REGISTER_VARIABLE(ADJOINT_ENERGY)
    KRATOS_REGISTER_VARIABLE(DIFFUSION_ENERGY)

    // ------------------- Testing Variables --------------------
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_1_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_2_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_3_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_4_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_5_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_6_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_7_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_8_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_9_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_10_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_11_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_12_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_13_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_14_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_15_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_16_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_17_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_18_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_19_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_20_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_21_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_22_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_23_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_24_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_25_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_26_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_27_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_28_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_29_EIGEN_MIN);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_1_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_2_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_3_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_4_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_5_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_6_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_7_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_8_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_9_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_10_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_11_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_12_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_13_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_14_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_15_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_16_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_17_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_18_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_19_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_20_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_21_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_22_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_23_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_24_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_25_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_26_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_27_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_28_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_29_EIGEN_MAX);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_1_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_2_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_3_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_4_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_5_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_6_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_7_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_8_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_9_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_10_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_11_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_12_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_13_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_14_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_15_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_16_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_17_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_18_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_19_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_20_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_21_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_22_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_23_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_24_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_25_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_26_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_27_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_28_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_29_ENERGY);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION_EIGEN_MAX);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION_EIGEN_MAX);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_PRIMAL_GRADIENT_OF_VMS_STEADY_TERM_EIGEN_MAX);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_CUSTOM);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_CUSTOM_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_CUSTOM_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_CUSTOM_EIGEN_MAX);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_DIFFUSION);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_ENERGY);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_EIGEN_MIN);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_DIFFUSION_EIGEN_MAX);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_PURE_DIFFUSION);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_ADJOINT_VECTOR);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_GAUSS_POINT_INTEGRATION_WEIGHT);

    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_24);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_29);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRICES);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_BEFORE_STABILIZATION);
    KRATOS_REGISTER_VARIABLE(STABILIZATION_ANALYSIS_MATRIX_LHS_AFTER_STABILIZATION);
