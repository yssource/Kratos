                              ...
                              ProcessInfo& rCurrentProcessInfo) override
    {
        ...
        for(unsigned int igauss = 0; igauss<Ncontainer.size1(); igauss++)
        {
            ...
            {*/
                ...
                data.f_gauss[0] = (0.4*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) + 72.0 + 0.00531648/pow(1.5*x + 3*y + 2.4, 2) - 0.4*(1792*t + 2560*x + 3072*y + 11008)/(x + 2*y + 1.6) + 64*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) - 32*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) + (2048*t + 2048*x + 4096*y + 10240)/(0.5*x + y + 0.8) - (-8*t + 16*x - 32*y + 24)*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) - 0.5*pow(32*t + 32*x + 64*y + 160, 2)/pow(0.5*x + y + 0.8, 2) + 0.00255978666666667/pow(0.5*x + y + 0.8, 2) + 1.23066666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) - 3.692e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3) - 1.23066666666667e-5*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8);

                data.f_gauss[1] = (0.8*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) - 208.0 - 0.01063296/pow(1.5*x + 3*y + 2.4, 2) - 0.4*(4608*t + 3072*x + 10240*y + 18944)/(x + 2*y + 1.6) + 32*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) + 16*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) + (512*t - 1024*x + 2048*y - 1536)/(0.5*x + y + 0.8) - pow(-8*t + 16*x - 32*y + 24, 2)/pow(0.5*x + y + 0.8, 2) - 0.5*(-8*t + 16*x - 32*y + 24)*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) + 0.00029536/pow(0.5*x + y + 0.8, 2) - 4.92266666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) + 2.46133333333333e-5*(16.0*t + 16.0*x + 32.0*y + 80.0)/pow(0.5*x + y + 0.8, 3) - 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8);

                data.r_gauss = (-(-0.00236288/pow(0.5*x + y + 0.8, 2) + 3.692e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3))*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) - (-0.0014768/pow(0.5*x + y + 0.8, 2) + 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3))*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) - 80*(0.0014768/(0.5*x + y + 0.8) - 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 2))/(0.5*x + y + 0.8) + 0.5*(0.0014768/(0.5*x + y + 0.8) - 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 2))*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) + (0.0014768/(0.5*x + y + 0.8) - 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 2))*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) + 0.00783426183844011*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(0.5*x + y + 0.8, 4) + 1 - 484650.0/pow(359.0*x + 718*y + 574.4, 2) + (0.4*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) + 140.0 - 0.4*(1792*t + 2560*x + 3072*y + 11008)/(x + 2*y + 1.6))*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) + (0.8*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) - 700.0 - 0.4*(4608*t + 3072*x + 10240*y + 18944)/(x + 2*y + 1.6))*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) + 32*(-0.00354432/(1.5*x + 3*y + 2.4) - 2.46133333333333e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) + 1.23066666666667e-5*(16.0*t + 16.0*x + 32.0*y + 80.0)/pow(0.5*x + y + 0.8, 2))/(0.5*x + y + 0.8) - 32*(0.00354432/(1.5*x + 3*y + 2.4) + 1.23066666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) - 1.23066666666667e-5*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2))/(0.5*x + y + 0.8) - (-8*t + 16*x - 32*y + 24)*(0.01063296/pow(1.5*x + 3*y + 2.4, 2) + 0.00118144/pow(0.5*x + y + 0.8, 2) + 4.92266666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) - 2.46133333333333e-5*(16.0*t + 16.0*x + 32.0*y + 80.0)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8) - (-8*t + 16*x - 32*y + 24)*(0.8*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) - 208.0 - 0.01063296/pow(1.5*x + 3*y + 2.4, 2) - 0.4*(4608*t + 3072*x + 10240*y + 18944)/(x + 2*y + 1.6) + 32*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) + 16*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) + (512*t - 1024*x + 2048*y - 1536)/(0.5*x + y + 0.8) - pow(-8*t + 16*x - 32*y + 24, 2)/pow(0.5*x + y + 0.8, 2) - 0.5*(-8*t + 16*x - 32*y + 24)*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) + 0.00029536/pow(0.5*x + y + 0.8, 2) - 4.92266666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) + 2.46133333333333e-5*(16.0*t + 16.0*x + 32.0*y + 80.0)/pow(0.5*x + y + 0.8, 3) - 1.846e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8) - (32*t + 32*x + 64*y + 160)*(-0.00531648/pow(1.5*x + 3*y + 2.4, 2) - 0.000196906666666667/pow(0.5*x + y + 0.8, 2) - 1.23066666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) + 1.23066666666667e-5*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8) - (32*t + 32*x + 64*y + 160)*(0.4*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/pow(x + 2*y + 1.6, 2) + 72.0 + 0.00531648/pow(1.5*x + 3*y + 2.4, 2) - 0.4*(1792*t + 2560*x + 3072*y + 11008)/(x + 2*y + 1.6) + 64*(-8*t + 16*x - 32*y + 24)/(0.5*x + y + 0.8) - 32*(32*t + 32*x + 64*y + 160)/(0.5*x + y + 0.8) + (2048*t + 2048*x + 4096*y + 10240)/(0.5*x + y + 0.8) - (-8*t + 16*x - 32*y + 24)*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) - 0.5*pow(32*t + 32*x + 64*y + 160, 2)/pow(0.5*x + y + 0.8, 2) + 0.00255978666666667/pow(0.5*x + y + 0.8, 2) + 1.23066666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 3) - 3.692e-5*(28.0*t + 40.0*x + 48.0*y + 172.0)/pow(0.5*x + y + 0.8, 3) - 1.23066666666667e-5*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8) + (-0.00354432/(1.5*x + 3*y + 2.4) - 2.46133333333333e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) + 1.23066666666667e-5*(16.0*t + 16.0*x + 32.0*y + 80.0)/pow(0.5*x + y + 0.8, 2))*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) + 0.5*(0.00354432/(1.5*x + 3*y + 2.4) + 1.23066666666667e-5*(-8*t + 16*x - 32*y + 24)/pow(0.5*x + y + 0.8, 2) - 1.23066666666667e-5*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2))*(32*t + 32*x + 64*y + 160)/pow(0.5*x + y + 0.8, 2) - (-8*t + 16*x - 32*y + 24)*(1.4*t + 140.0*x - 700.0*y - 0.4*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/(x + 2*y + 1.6) + 51100.0)/pow(0.5*x + y + 0.8, 2) - 0.5*(32*t + 32*x + 64*y + 160)*(1.4*t + 140.0*x - 700.0*y - 0.4*(pow(-8*t + 16*x - 32*y + 24, 2) + pow(32*t + 32*x + 64*y + 160, 2))/(x + 2*y + 1.6) + 51100.0)/pow(0.5*x + y + 0.8, 2) + 12.4303621169916/pow(0.5*x + y + 0.8, 2) - 0.00348189415041783*(1.5*t + 150.0*x - 750.0*y + 54750.0)/pow(0.5*x + y + 0.8, 3) - 0.0020891364902507*(896*t + 1280*x + 1536*y + 5504)/pow(0.5*x + y + 0.8, 3) - 0.00104456824512535*(1792*t + 2560*x + 3072*y + 11008)/pow(0.5*x + y + 0.8, 3) - 0.00417827298050139*(2304*t + 1536*x + 5120*y + 9472)/pow(0.5*x + y + 0.8, 3) - 0.0020891364902507*(4608*t + 3072*x + 10240*y + 18944)/pow(0.5*x + y + 0.8, 3))/(0.5*x + y + 0.8);
