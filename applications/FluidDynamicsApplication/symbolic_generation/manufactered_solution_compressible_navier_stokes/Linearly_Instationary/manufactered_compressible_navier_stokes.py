...
u = 32
v = 8
m_u =  u*(1*x+2*y+5+t)         #DIVERGENCE FREE
m_v = v*(2*x-4*y+3-t)              #DIVERGENCE FREE
et = (100*x -500*y +36500+t) #MUST BE POSITIVE
print("rho = ", rho)
print("m_U = ", m_u)
print("m_v = ", m_v)
print("et = ", et)
...
print("CHECK DIVERGENCE: ", diff(m_u,x), "    =  ", diff(m_v,y))
'''
for x in range(0,4):
    for y in range(0,2):
        for i in range(0,10):      
            ...
            #print(u)
            v = 8
            m_u =  u*t*(1*x+2*y+5)+230
            m_v = v*t*(2*x-4*y+3-t)-100
            et = (100*x -500*y +36500+t)+2000
