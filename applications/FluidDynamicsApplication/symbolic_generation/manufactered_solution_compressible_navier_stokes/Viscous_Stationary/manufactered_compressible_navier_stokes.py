...
'''
tau_uxx = tau_uxx.subs(x,4.1)
tau_uxx = tau_uxx.subs(y,0.5)
tau_xx = tau_xx.subs(x,4.1)
tau_xx = tau_xx.subs(y,0.5)
tau_uyy = tau_uyy.subs(x,4.1)
tau_uyy = tau_uyy.subs(y,0.5)
tau_yy = tau_yy.subs(x,4.1)
tau_yy = tau_yy.subs(y,0.5)
tau_uxy = tau_uxy.subs(x,4.1)
tau_uxy = tau_uxy.subs(y,0.5)
tau_xy = tau_xy.subs(x,4.1)
tau_xy = tau_xy.subs(y,0.5)
'''
