...
namespace Kratos {
	namespace Testing {
	     ...
	     */
        /*
	    KRATOS_TEST_CASE_IN_SUITE(ElementCompressibleNavierStokes2D3N, FluidDynamicsApplicationFastSuite)
		{
        ...
        */
		 ...
		 */
	    KRATOS_TEST_CASE_IN_SUITE(ElementCompressibleNavierStokes2D3NStationary, FluidDynamicsApplicationFastSuite)
		{
...
//             std::cout<<*pElement<<std::endl; //Info on element
	    ...
	    //  */
	    /*
	    KRATOS_TEST_CASE_IN_SUITE(ElementCompressibleNavierStokes3D4N, FluidDynamicsApplicationFastSuite)
		{
		...
		KRATOS_TEST_CASE_IN_SUITE(ElementCompressibleNavierStokes3D4NStationary, FluidDynamicsApplicationFastSuite)
		{
