proc WriteMdpa { basename dir problemtypedir } {
    ...
    # Soil part
    set Groups [GiD_Info conditions Soil groups]
    ...
    # Interface_Part
    set Groups [GiD_Info conditions Interface groups]
    for {set i 0} {$i < [llength $Groups]} {incr i} {
    ...
    ## SubModelParts
    # Soil part
    WriteElementSubmodelPart FileVar Soil
    # Interface Part
    WriteElementSubmodelPart FileVar Interface
    # PropagationUnion (InterfaceElement)
    if {[GiD_Groups exists PropagationUnion_3d_6] eq 1} {
    ...
    # Periodic_Bars
    if {$IsPeriodic eq true} {
        WritePeriodicBarsSubmodelPart FileVar Interface $ConditionDict
    }
