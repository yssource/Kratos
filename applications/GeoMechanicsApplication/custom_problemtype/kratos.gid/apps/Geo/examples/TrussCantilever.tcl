...
proc ::Geo::examples::TrussCantilever {args} {
...
proc Geo::examples::DrawTrussCantileverGeometry {args} {
    Kratos::ResetModel
...
proc Geo::examples::AssignTrussCantileverMeshSizes {args} {
    GiD_Process Mescape Meshing Structured Lines 1 {*}[GiD_EntitiesGroups get Structure lines] escape escape 
}


proc Geo::examples::TreeAssignationTrussCantilever {args} {
    ...
    # Geo
    # gid_groups_conds::setAttributesF {container[@n='FSI']/container[@n='Geo']/container[@n='StageInfo']/value[@n='SolutionType']} {v Dynamic}

    # Geo Parts
    set structParts {container[@n='Geo']/condition[@n='Parts']}
    ...
    set structDisplacement {container[@n='Geo']/container[@n='Boundary Conditions']/condition[@n='DISPLACEMENT']}
    ...
    # Point load
    set structLoad "container\[@n='Geo'\]/container\[@n='Loads'\]/condition\[@n='PointLoad$nd'\]"
