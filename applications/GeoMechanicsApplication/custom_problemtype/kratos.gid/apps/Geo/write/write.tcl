...
proc Geo::write::Init { } {
    ...
    SetAttribute validApps [list "Geo"]
    ...
    SetAttribute materials_file "GeoMaterials.json"
    SetAttribute main_script_file "KratosGeo.py"
}

proc Geo::write::GetAttribute {att} {
    variable writeAttributes
    return [dict get $writeAttributes $att]
}

proc Geo::write::GetAttributes {} {
    variable writeAttributes
    return $writeAttributes
}

proc Geo::write::SetAttribute {att val} {
    variable writeAttributes
    dict set writeAttributes $att $val
}

proc Geo::write::AddAttribute {att val} {
    variable writeAttributes
    dict append writeAttributes $att $val]
}

proc Geo::write::AddAttributes {configuration} {
    variable writeAttributes
    set writeAttributes [dict merge $writeAttributes $configuration]
}

proc Geo::write::AddValidApps {appList} {
    AddAttribute validApps $appList
}

proc Geo::write::writeCustomFilesEvent { } {
    WriteMaterialsFile
...
proc Geo::write::SetCoordinatesByGroups {value} {
    SetAttribute writeCoordinatesByGroups $value
}

proc Geo::write::ApplyConfiguration { } {
    variable writeAttributes
    write::SetConfigurationAttributes $writeAttributes
}

# MDPA Blocks
proc Geo::write::writeModelPartEvent { } {
    variable ConditionsDictGroupIterators
    ...
    # Nodal coordinates (1: Print only Geo nodes <inefficient> | 0: the whole mesh <efficient>)
    ...
    # Local Axes
    Geo::write::writeLocalAxes

    # Hinges special section
    Geo::write::writeHinges

    # Write Conditions section
    Geo::write::writeConditions

    # SubmodelParts
    Geo::write::writeMeshes
...
proc Geo::write::writeContacts { } {
    variable ConditionsDictGroupIterators
    if {[Geo::write::usesContact]} {
        set root [customlib::GetBaseRoot]
...
proc Geo::write::writeCustomBlock { } {
    write::WriteString "Begin Custom"
    write::WriteString "Custom write for Geo, any app can call me, so be careful!"
    write::WriteString "End Custom"
    write::WriteString ""
}

proc Geo::write::getLastConditionId { } { 
    variable ConditionsDictGroupIterators
    set top 1
...
proc Geo::write::initLocalWriteConfiguration { } {
    
    if {[usesContact]} {
         SetAttribute main_script_file "KratosContactGeo.py"
    }
}

proc Geo::write::usesContact { } {
