...
proc Geo::write::getOldParametersDict { } {
    ...
    if {$solutiontype eq "eigen_value"} {
        ...
        dict set eigen_process_dict kratos_module KratosMultiphysics.GeoMechanicsApplication
    ...
    if {$solutiontype eq "formfinding"} {
        ...
        dict set formfinding_process_dict kratos_module KratosMultiphysics.GeoMechanicsApplication
        ...
        dict set params "read_prestress" [Geo::write::UsingFileInPrestressedMembrane]
    ...
    set solverSettingsDict [dict merge $solverSettingsDict [write::getSolversParametersDict Geo] ]
    ...
    foreach elem $check_list {
        if {$elem in [Geo::write::GetUsedElements Name]} {
...
proc Geo::write::GetContactConditionsDict { } {
    ...
    dict set contact_process_dict kratos_module "KratosMultiphysics.ContactGeoMechanicsApplication"
...
proc Geo::write::writeParametersEvent { } {
...
# Project Parameters
proc Geo::write::getParametersEvent { } {
...
proc Geo::write::writeParametersEvent { } {
    write::WriteJSON [::Geo::write::getParametersEvent]
}

proc Geo::write::UsingRotationDofElements { } {
    set root [customlib::GetBaseRoot]
...
proc Geo::write::UsingFileInPrestressedMembrane { } {
    set root [customlib::GetBaseRoot]
    set xp1 "[spdAux::getRoute [GetAttribute parts_un]]/group/value\[@n='Element'\]"
    set elements [$root selectNodes $xp1]
    set found false
