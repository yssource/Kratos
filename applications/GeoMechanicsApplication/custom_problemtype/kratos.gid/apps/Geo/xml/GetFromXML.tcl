namespace eval Geo::xml {
     variable dir
}

proc Geo::xml::Init { } {
     variable dir
     Model::InitVariables dir $Geo::dir
...
proc Geo::xml::getUniqueName {name} {
    return ST$name
}

proc ::Geo::xml::MultiAppEvent {args} {

}

proc Geo::xml::CustomTree { args } {
...
proc Geo::xml::ProcCheckGeometryGeo {domNode args} {
...
proc Geo::xml::ProcGetSolutionStrategiesGeo { domNode args } {
    set names ""
    set pnames ""
...
proc Geo::xml::ProcCheckNodalConditionStateSolid {domNode args} {
...
proc Geo::xml::ProcCheckGeometrySolid {domNode args} {
    set ret "surface"
    if {$::Model::SpatialDimension eq "3D"} {
...
proc Geo::xml::UpdateParts {domNode args} {
...
proc Geo::xml::AddLocalAxesToBeamElement { current } {
...
############# procs #################
proc Geo::xml::ProcGetElementsGeo { domNode args } {
