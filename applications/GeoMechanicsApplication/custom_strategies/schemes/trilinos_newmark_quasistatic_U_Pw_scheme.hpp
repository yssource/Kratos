...
class TrilinosNewmarkQuasistaticUPwScheme : public NewmarkQuasistaticUPwScheme<TSparseSpace,TDenseSpace>
{

public:

    KRATOS_CLASS_POINTER_DEFINITION( TrilinosNewmarkQuasistaticUPwScheme );
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    ///Constructor
    TrilinosNewmarkQuasistaticUPwScheme(double beta, double gamma, double theta) 
...
#endif // KRATOS_TRILINOS_NEWMARK_QUASISTATIC_U_PW_SCHEME defined