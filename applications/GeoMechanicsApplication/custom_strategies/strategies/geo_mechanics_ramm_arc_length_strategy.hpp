...
class GeoMechanicsRammArcLengthStrategy : public GeoMechanicsNewtonRaphsonStrategy<TSparseSpace, TDenseSpace, TLinearSolver>
{
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    GeoMechanicsRammArcLengthStrategy(
        ...
        ) : GeoMechanicsNewtonRaphsonStrategy<TSparseSpace, TDenseSpace, TLinearSolver>(model_part, pScheme, pNewLinearSolver,
