...
main_model_part.ProcessInfo.SetValue(KratosGeo.TIME_UNIT_CONVERTER, 1.0)
...
if parallel_type == "OpenMP":
    ...
    geomechanics_cleaning_utility.CleanPreviousFiles(problem_path) # Clean previous post files
