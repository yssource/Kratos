    ...
    const bool ComputeRightHandSide)
{
    ...
    // IgaDebug::CheckVector(expected_data,"shape_1", shape_derivatives);
    // IgaDebug::CheckVector(expected_data,"shape_2", shape_derivatives);
    ...
    // ElementStiffnessMatrixNonlinear(_emod, _gmod, _area, _m_inert_y, _m_inert_z, _mt_inert, _dl, _gke, _gfie);
    //  double _emod,
    //     double _gmod,
    //     double _area,
    //     double _m_inert_y,
