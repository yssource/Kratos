...
public:
    ...
    // IgaBaseElement();
    // IgaBeamMomentCondition(
    //     int _ID, 
    //     Part* _Part_Prt,
    //     std::vector<Node*> _Node_Vec,
    //     MaterialBasis* _Mat_Prt,
    //     PropertyIgaBeamMomentCondition* _Prop_Prt,
...
void IgaBeamMomentCondition::ComputeCrossSectionGeometryActual(
    ...
    void IgaBeamMomentCondition::GetDofsPerNode(
        std::vector<int>& _act_dofs) ;

    // Vector IgaBeamMomentCondition::GetElementResult(
    //     node_result_type _type); 

    Vector IgaBeamMomentCondition::ComputeEpsilonFirstDerivative(Vector3 _r1) ;

    Matrix IgaBeamMomentCondition::ComputeEpsilonSecondDerivative();        //change 17.11   (Vector3 _r1) ;
    ...
    // Vector IgaBeamMomentCondition::ComputePhiDof(Vector& _func) ;        //changes 17.11     funktion nicht benötigt

    void IgaBeamMomentCondition::ComputeMatrixLambda(
        BoundedMatrix<double,3,3>& _matrix_lambda,
        BoundedVector<double,3> _vec1,
        BoundedVector<double,3> _vec2) ;

    void IgaBeamMomentCondition::ComputeMatrixLambdaFirstDerivative(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaSecondDerivative(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaVariation(
        Matrix& _matrix_lambda_var,
        BoundedVector<double,3> _vec1,
        BoundedVector<double,3> _vec2,
        BoundedVector<double,3> _vec2_var) ;

    void IgaBeamMomentCondition::ComputeMatrixLambdaFirstDerivativeVariation(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaSecondDerivativeVariation(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaSecondVariation(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaFirstDerivativeSecondVariation(
    ...
    void IgaBeamMomentCondition::ComputeMatrixLambdaAll(
    ...
    void IgaBeamMomentCondition::StffnessMatrixElementLinear(
        double _emod,
        double _gmod,
        double _area,
        double _m_inert_n,
    ...
    void IgaBeamMomentCondition::ComputeMatrixRodriuez(
        BoundedMatrix<double,3,3>& _matrix_rodrigues,
        BoundedVector<double,3> _vec,
        double phi) ;

    void IgaBeamMomentCondition::ComputeMatrixRodriuezFirstDerivative(
    ...
    void IgaBeamMomentCondition::ComputeTVariation(
        Vector& _t_var,
        Vector  _r1,
        Matrix  _deriv);
