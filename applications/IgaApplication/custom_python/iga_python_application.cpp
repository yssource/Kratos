...
PYBIND11_MODULE(KratosIgaApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DISPLACEMENT_ROTATION)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REACTION_ROTATION)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PHI)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PHI_0_DER)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, T0)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, N0)
    
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MOMENT_OF_INERTIA_Y)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MOMENT_OF_INERTIA_Z)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MOMENT_OF_INERTIA_T)

    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LOAD_VECTOR_MOMENT)


    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEBUG_EXPECTED_DATA)
