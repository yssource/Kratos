...
KRATOS_CREATE_VARIABLE(Vector, GAUSS_POINT)
...
KRATOS_CREATE_VARIABLE(Vector, SHAPE_FUNCTION_VALUES_B)
KRATOS_CREATE_VARIABLE(Vector, SHAPE_FUNCTION_LOCAL_DER_1_B)
KRATOS_CREATE_VARIABLE(Vector, SHAPE_FUNCTION_LOCAL_DER_2_B)
KRATOS_CREATE_VARIABLE(Vector, SHAPE_FUNCTION_LOCAL_DER_3_B)
...
KRATOS_CREATE_VARIABLE(double, ALPHA_LOAD)
...
KRATOS_CREATE_VARIABLE(Vector, BASE_B1)
KRATOS_CREATE_VARIABLE(Vector, BASE_B2)
KRATOS_CREATE_VARIABLE(Vector, BASE_B3)
KRATOS_CREATE_VARIABLE(Vector, BASE_B1_1)
...
KRATOS_CREATE_VARIABLE(Vector, LOAD_VECTOR_FORCE)
...
KRATOS_CREATE_VARIABLE(double, PENALTY_ROTATION_2)
KRATOS_CREATE_VARIABLE(double, PENALTY_ROTATION_3)
