...
KRATOS_DEFINE_VARIABLE(Vector, GAUSS_POINT)
...
KRATOS_DEFINE_VARIABLE(double, ALPHA_LOAD)
...
KRATOS_DEFINE_VARIABLE(Vector, LOAD_VECTOR_FORCE)
...
KRATOS_DEFINE_VARIABLE(double, PENALTY_ROTATION_2)
KRATOS_DEFINE_VARIABLE(double, PENALTY_ROTATION_3)
