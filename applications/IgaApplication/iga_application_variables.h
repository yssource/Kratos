...
KRATOS_DEFINE_VARIABLE(double, DISPLACEMENT_PENALTY_X)
KRATOS_DEFINE_VARIABLE(double, DISPLACEMENT_PENALTY_Y)
KRATOS_DEFINE_VARIABLE(double, DISPLACEMENT_PENALTY_Z)
KRATOS_DEFINE_VARIABLE(double, DISPLACEMENT_PENALTY_ALPHA_2)
KRATOS_DEFINE_VARIABLE(double, DISPLACEMENT_PENALTY_ALPHA_3)
