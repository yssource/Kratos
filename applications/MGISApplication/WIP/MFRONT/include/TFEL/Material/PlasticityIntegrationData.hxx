/*!
* \file   TFEL/Material/PlasticityIntegrationData.hxx
* \brief  this file implements the PlasticityIntegrationData class.
*         File generated by tfel version 3.3.0-dev
* \author Helfer Thomas
* \date   23 / 11 / 06
 */

#ifndef LIB_TFELMATERIAL_PLASTICITY_INTEGRATION_DATA_HXX
#define LIB_TFELMATERIAL_PLASTICITY_INTEGRATION_DATA_HXX
...
std::ostream&
 operator <<(std::ostream&,const PlasticityIntegrationData<hypothesis,Type,false>&);

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
class PlasticityIntegrationData<hypothesis,Type,false>
{
...
friend std::ostream& operator<< <>(std::ostream&,const PlasticityIntegrationData&);
...
*/
PlasticityIntegrationData()
{}

/*!
* \brief Copy constructor
*/
PlasticityIntegrationData(const PlasticityIntegrationData& src)
: deto(src.deto),
dt(src.dt),
dT(src.dT)
{}
 ...
 */
PlasticityIntegrationData(const mfront::gb::BehaviourData& mgb_d)
: dt(mgb_d.dt),
...
PlasticityIntegrationData&
>::type
scale(const PlasticityBehaviourData<hypothesis,Type,false>&, const Scal time_scaling_factor){
...
*/
PlasticityIntegrationData&
updateDrivingVariables(const PlasticityBehaviourData<hypothesis,Type,false>&){
return *this;
}

}; // end of PlasticityIntegrationDataclass

template<ModellingHypothesis::Hypothesis hypothesis,typename Type>
std::ostream&
operator <<(std::ostream& os,const PlasticityIntegrationData<hypothesis,Type,false>& b)
{
using namespace std;
os << "deto : " << b.deto << '\n';
os << "dt : " << b.dt << endl;
...
#endif /* LIB_TFELMATERIAL_PLASTICITY_INTEGRATION_DATA_HXX */
