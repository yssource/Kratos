...
#if !defined(KRATOS_MGIS_APPLICATION_VARIABLES_H_INCLUDED )
#define  KRATOS_MGIS_APPLICATION_VARIABLES_H_INCLUDED
...
#endif	/* KRATOS_MGIS_APPLICATION_VARIABLES_H_INCLUDED */
