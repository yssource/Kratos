...
void AddCustomUtilitiesToPython(pybind11::module& m)
{
    namespace py = pybind11;
     ...
     py::class_< ManufacturedSolutionUtility, ManufacturedSolutionUtility::Pointer>(m, "ManufacturedSolutionUtility")
        ...
        .def("ComputeExactConvection", &ManufacturedSolutionUtility::ComputeExactConvection)
        ...
        .def("Bossak", &ManufacturedSolutionUtility::Bossak<Variable<double>>)
        .def("Bossak", &ManufacturedSolutionUtility::Bossak<Variable<array_1d<double,3>>>)
        .def("Bossak", &ManufacturedSolutionUtility::Bossak<Variable<array_1d<double,4>>>)
        .def("Bossak", &ManufacturedSolutionUtility::Bossak<Variable<array_1d<double,6>>>)
        .def("Bossak", &ManufacturedSolutionUtility::Bossak<Variable<array_1d<double,9>>>)
