...
#if !defined(KRATOS_MANUFACTURED_FLUID_SOLUTIONS_APPLICATION_VARIABLES_H_INCLUDED )
...
KRATOS_DEFINE_APPLICATION_VARIABLE( KRATOS_MANUFACTURED_FLUID_SOLUTIONS_APPLICATION, double, VELOCITY_RELATIVE_ERROR )
...
KRATOS_DEFINE_APPLICATION_VARIABLE( KRATOS_MANUFACTURED_FLUID_SOLUTIONS_APPLICATION, Parameters::Pointer, MANUFACTURED_PARAMETERS )
