...
*format "%10.5e"
 ...
 ANISOTROPIC_PERMEABILITY 0
*if(strcmp(MatProp(ANISOTROPIC_PERMEABILITY),"True")==0)
 ANISOTROPIC_PERMEABILITY 1
*endif
*format "%10.5e"
 VERTICAL_PERMEABILITY *MatProp(VERTICAL_PERMEABILITY,real)
*format "%10.5e"
 HORIZONTAL_PERMEABILITY *MatProp(HORIZONTAL_PERMEABILITY,real)
 TRANSFORM_PERMEABILITY_TENSOR 0
*if(strcmp(MatProp(TRANSFORM_PERMEABILITY_TENSOR),"True")==0)
 TRANSFORM_PERMEABILITY_TENSOR 1
*endif
*format "%10.5e"
...
*format "%10.5e"
 INITIAL_BONDING *MatProp(INITIAL_BONDING,real)
*format "%10.5e"
 DEGRADATION_THRESHOLD *MatProp(DEGRADATION_THRESHOLD,real)
*format "%10.5e"
 DEGRADATION_RATE_COMPRESSION *MatProp(DEGRADATION_RATE_COMPRESSION,real)
*format "%10.5e"
 DEGRADATION_RATE_SHEAR *MatProp(DEGRADATION_RATE_SHEAR,real)
*format "%10.5e"
 ALPHA_TENSILE *MatProp(ALPHA_TENSILE,real)
*format "%10.5e"
 PLASTIC_DEVIATORIC_STRAIN_HARDENING *MatProp(PLASTIC_DEVIATORIC_STRAIN_HARDENING,real)
*format "%10.5e"
 DENSITY_WATER *MatProp(WATER_DENSITY,real)
*format "%10.5e"
 WATER_BULK_MODULUS *MatProp(WATER_BULK_MODULUS,real)
