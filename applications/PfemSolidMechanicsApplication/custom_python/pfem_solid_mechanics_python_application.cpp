...
PYBIND11_MODULE(KratosPfemSolidMechanicsApplication,m)
{
  ...
  py::class_<KratosPfemSolidMechanicsApplication,
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, BONDING )
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INCR_VOL_PLASTIC )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CRITICAL_STATE_M )
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PERMEABILITY_TENSOR )
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TOTAL_DEFORMATION_GRADIENT )
