...
#if !defined(KRATOS_EVM_EPSILON_WALL_CONDITION_H_INCLUDED )
#define KRATOS_EVM_EPSILON_WALL_CONDITION_H_INCLUDED
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(EvmEpsilonWallCondition);
     ...
     * Constructor.
     */
    EvmEpsilonWallCondition(IndexType NewId = 0);
     ...
     */
    EvmEpsilonWallCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);
...
#endif // KRATOS_EVM_EPSILON_WALL_CONDITION_H_INCLUDED  defined
