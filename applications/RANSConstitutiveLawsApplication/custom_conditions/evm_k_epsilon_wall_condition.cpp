...
EvmKEpsilonWallCondition<TDim, TNumNodes>::EvmKEpsilonWallCondition(IndexType NewId)
    : Condition(NewId)
{
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes>::EvmKEpsilonWallCondition(IndexType NewId, const NodesArrayType& ThisNodes)
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes>::EvmKEpsilonWallCondition(IndexType NewId, GeometryType::Pointer pGeometry)
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes>::EvmKEpsilonWallCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties)
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes>::EvmKEpsilonWallCondition(EvmKEpsilonWallCondition const& rOther)
    : Condition(rOther)
{
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes>::~EvmKEpsilonWallCondition() { }
...
/// Assignment operator.
template<unsigned int TDim, unsigned int TNumNodes>
EvmKEpsilonWallCondition<TDim, TNumNodes> & EvmKEpsilonWallCondition<TDim, TNumNodes>::operator=(EvmKEpsilonWallCondition<TDim, TNumNodes> const& rOther)
{
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
Condition::Pointer EvmKEpsilonWallCondition<TDim, TNumNodes>::Create(
    IndexType NewId,
    ...
    PropertiesType::Pointer pProperties) const
{
    ...
    KRATOS_TRY
    return Kratos::make_shared<EvmKEpsilonWallCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    KRATOS_CATCH("");
}
    ...
    PropertiesType::Pointer pProperties) const
{
    ...
    KRATOS_TRY
    return Kratos::make_shared<EvmKEpsilonWallCondition>(NewId, pGeom, pProperties);
    KRATOS_CATCH("");
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
Condition::Pointer EvmKEpsilonWallCondition<TDim, TNumNodes>::Clone(IndexType NewId, NodesArrayType const& ThisNodes) const
{
    KRATOS_TRY
    return Kratos::make_shared<EvmKEpsilonWallCondition>(NewId, GetGeometry().Create(ThisNodes), pGetProperties());
    KRATOS_CATCH("");
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateLocalSystem(
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateFirstDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateFirstDerivativesLHS(MatrixType& rLeftHandSideMatrix, ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
        rLeftHandSideMatrix.resize(0, 0, false);
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateFirstDerivativesRHS(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
    rRightHandSideVector.resize(0, false);
}
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateSecondDerivativesContributions(
    MatrixType& rLeftHandSideMatrix,
    VectorType& rRightHandSideVector,
    ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateSecondDerivativesLHS(
    MatrixType& rLeftHandSideMatrix,
    ProcessInfo& rCurrentProcessInfo)
{
    if (rLeftHandSideMatrix.size1() != 0)
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateSecondDerivativesRHS(
    VectorType& rRightHandSideVector,
    ProcessInfo& rCurrentProcessInfo)
{
    if (rRightHandSideVector.size() != 0)
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateMassMatrix(MatrixType& rMassMatrix, ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::CalculateDampingMatrix(MatrixType& rDampingMatrix, ProcessInfo& rCurrentProcessInfo)
{
 ...
 */
template<unsigned int TDim, unsigned int TNumNodes>
int EvmKEpsilonWallCondition<TDim, TNumNodes>::Check(const ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY

    KRATOS_ERROR_IF(this->Id() < 1) <<"EvmKEpsilonWallCondition found with Id 0 or negative" << std::endl;

    KRATOS_ERROR_IF(this->GetGeometry().Area() <= 0) << "On EvmKEpsilonWallCondition -> "
...
template<unsigned int TDim, unsigned int TNumNodes>
std::string EvmKEpsilonWallCondition<TDim, TNumNodes>::Info() const {
    std::stringstream buffer;
    buffer << "EvmKEpsilonWallCondition #" << Id();
    return buffer.str();
}
...
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::PrintInfo(std::ostream& rOStream) const {
    rOStream << "EvmKEpsilonWallCondition #" << Id();
}

/// Print object's data.

template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::PrintData(std::ostream& rOStream) const {
...
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::save(Serializer& rSerializer) const {
...
template<unsigned int TDim, unsigned int TNumNodes>
void EvmKEpsilonWallCondition<TDim, TNumNodes>::load(Serializer& rSerializer) {
...
template<unsigned int TDim, unsigned int TNumNodes>
inline std::ostream & operator << (std::ostream& rOStream, const EvmKEpsilonWallCondition<TDim, TNumNodes>& rThis) {
...
template class EvmKEpsilonWallCondition<2, 2>;
template class EvmKEpsilonWallCondition<3, 3>;
