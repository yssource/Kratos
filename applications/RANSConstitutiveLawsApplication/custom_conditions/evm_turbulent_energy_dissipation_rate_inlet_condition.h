...
#if !defined(KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_INLET_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_INLET_CONDITION_H_INCLUDED
...
class EvmTurbulentEnergyDissipationRateInletCondition : public Condition
{
public:
    ...
    /// Pointer definition of EvmTurbulentEnergyDissipationRateInletCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentEnergyDissipationRateInletCondition);
     ...
     * Constructor.
     */
    EvmTurbulentEnergyDissipationRateInletCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentEnergyDissipationRateInletCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentEnergyDissipationRateInletCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentEnergyDissipationRateInletCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentEnergyDissipationRateInletCondition(EvmTurbulentEnergyDissipationRateInletCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentEnergyDissipationRateInletCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentEnergyDissipationRateInletCondition & operator=(EvmTurbulentEnergyDissipationRateInletCondition const& rOther);
...
}; // Class EvmTurbulentEnergyDissipationRateInletCondition
...
#endif // KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_INLET_CONDITION_H_INCLUDED  defined
