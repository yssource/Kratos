...
#if !defined(KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_OUTLET_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_OUTLET_CONDITION_H_INCLUDED
...
class EvmTurbulentEnergyDissipationRateOutletCondition : public Condition
{
public:
    ...
    /// Pointer definition of EvmTurbulentEnergyDissipationRateOutletCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentEnergyDissipationRateOutletCondition);
     ...
     * Constructor.
     */
    EvmTurbulentEnergyDissipationRateOutletCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentEnergyDissipationRateOutletCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentEnergyDissipationRateOutletCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentEnergyDissipationRateOutletCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentEnergyDissipationRateOutletCondition(EvmTurbulentEnergyDissipationRateOutletCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentEnergyDissipationRateOutletCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentEnergyDissipationRateOutletCondition & operator=(EvmTurbulentEnergyDissipationRateOutletCondition const& rOther);
...
}; // Class EvmTurbulentEnergyDissipationRateOutletCondition
...
#endif // KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_OUTLET_CONDITION_H_INCLUDED  defined
