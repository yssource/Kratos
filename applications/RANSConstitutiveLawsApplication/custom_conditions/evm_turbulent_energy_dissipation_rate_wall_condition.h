...
#if !defined(KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_WALL_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_WALL_CONDITION_H_INCLUDED
...
public:
    ...
    /// Pointer definition of EvmTurbulentEnergyDissipationRateWallCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentEnergyDissipationRateWallCondition);
     ...
     * Constructor.
     */
    EvmTurbulentEnergyDissipationRateWallCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentEnergyDissipationRateWallCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentEnergyDissipationRateWallCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentEnergyDissipationRateWallCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentEnergyDissipationRateWallCondition(EvmTurbulentEnergyDissipationRateWallCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentEnergyDissipationRateWallCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentEnergyDissipationRateWallCondition & operator=(EvmTurbulentEnergyDissipationRateWallCondition const& rOther);
...
}; // Class EvmTurbulentEnergyDissipationRateWallCondition
...
#endif // KRATOS_EVM_TURBULENT_ENERGY_DISSIPATION_RATE_WALL_CONDITION_H_INCLUDED  defined
