...
#if !defined(KRATOS_EVM_TURBULENT_KINETIC_ENERGY_INLET_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_KINETIC_ENERGY_INLET_CONDITION_H_INCLUDED
...
class EvmTurbulentKineticEnergyInletCondition : public Condition
{
public:
    ...
    /// Pointer definition of EvmTurbulentKineticEnergyInletCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentKineticEnergyInletCondition);
     ...
     * Constructor.
     */
    EvmTurbulentKineticEnergyInletCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentKineticEnergyInletCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentKineticEnergyInletCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentKineticEnergyInletCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentKineticEnergyInletCondition(EvmTurbulentKineticEnergyInletCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentKineticEnergyInletCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentKineticEnergyInletCondition & operator=(EvmTurbulentKineticEnergyInletCondition const& rOther);
...
}; // Class EvmTurbulentKineticEnergyInletCondition
...
#endif // KRATOS_EVM_TURBULENT_KINETIC_ENERGY_INLET_CONDITION_H_INCLUDED  defined
