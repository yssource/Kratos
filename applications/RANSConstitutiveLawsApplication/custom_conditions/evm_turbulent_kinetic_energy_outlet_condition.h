...
#if !defined(KRATOS_EVM_TURBULENT_KINETIC_ENERGY_OUTLET_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_KINETIC_ENERGY_OUTLET_CONDITION_H_INCLUDED
...
class EvmTurbulentKineticEnergyOutletCondition : public Condition
{
public:
    ...
    /// Pointer definition of EvmTurbulentKineticEnergyOutletCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentKineticEnergyOutletCondition);
     ...
     * Constructor.
     */
    EvmTurbulentKineticEnergyOutletCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentKineticEnergyOutletCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentKineticEnergyOutletCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentKineticEnergyOutletCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentKineticEnergyOutletCondition(EvmTurbulentKineticEnergyOutletCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentKineticEnergyOutletCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentKineticEnergyOutletCondition & operator=(EvmTurbulentKineticEnergyOutletCondition const& rOther);
...
}; // Class EvmTurbulentKineticEnergyOutletCondition
...
#endif // KRATOS_EVM_TURBULENT_KINETIC_ENERGY_OUTLET_CONDITION_H_INCLUDED  defined
