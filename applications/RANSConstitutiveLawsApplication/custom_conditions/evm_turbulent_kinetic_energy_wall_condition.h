...
#if !defined(KRATOS_EVM_TURBULENT_KINETIC_ENERGY_WALL_CONDITION_H_INCLUDED )
#define KRATOS_EVM_TURBULENT_KINETIC_ENERGY_WALL_CONDITION_H_INCLUDED
...
class EvmTurbulentKineticEnergyWallCondition : public Condition
{
public:
    ...
    /// Pointer definition of EvmTurbulentKineticEnergyWallCondition
    KRATOS_CLASS_POINTER_DEFINITION(EvmTurbulentKineticEnergyWallCondition);
     ...
     * Constructor.
     */
    EvmTurbulentKineticEnergyWallCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmTurbulentKineticEnergyWallCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmTurbulentKineticEnergyWallCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmTurbulentKineticEnergyWallCondition(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

    /**
     * Copy Constructor
     */
    EvmTurbulentKineticEnergyWallCondition(EvmTurbulentKineticEnergyWallCondition const& rOther);

    /**
     * Destructor
     */
    ~EvmTurbulentKineticEnergyWallCondition() override;
    ...
    /// Assignment operator.
    EvmTurbulentKineticEnergyWallCondition & operator=(EvmTurbulentKineticEnergyWallCondition const& rOther);
...
}; // Class EvmTurbulentKineticEnergyWallCondition
...
#endif // KRATOS_EVM_TURBULENT_KINETIC_ENERGY_WALL_CONDITION_H_INCLUDED  defined
