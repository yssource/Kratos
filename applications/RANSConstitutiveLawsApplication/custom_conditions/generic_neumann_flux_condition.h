...
#if !defined(KRATOS_GENERIC_NEUMANN_FLUX_CONDITION_H_INCLUDED)
#define KRATOS_GENERIC_NEUMANN_FLUX_CONDITION_H_INCLUDED
...
class GenericNeumannFluxCondition : public Condition
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of GenericNeumannFluxCondition
    KRATOS_CLASS_POINTER_DEFINITION(GenericNeumannFluxCondition);
     ...
     * Constructor.
     */
    GenericNeumannFluxCondition(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    GenericNeumannFluxCondition(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    GenericNeumannFluxCondition(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    GenericNeumannFluxCondition(IndexType NewId,
     ...
     * Copy Constructor
     */
    GenericNeumannFluxCondition(GenericNeumannFluxCondition const& rOther);

    /**
     * Destructor
     */
    ~GenericNeumannFluxCondition() override;
    ...
    /// Assignment operator.
    GenericNeumannFluxCondition& operator=(GenericNeumannFluxCondition const& rOther);
...
}; // Class GenericNeumannFluxCondition
...
#endif // KRATOS_GENERIC_NEUMANN_FLUX_CONDITION_H_INCLUDED  defined
