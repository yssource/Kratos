...
#if !defined(KRATOS_EVM_LOG_EPSILON_ELEMENT_H_INCLUDED)
#define KRATOS_EVM_LOG_EPSILON_ELEMENT_H_INCLUDED
...
class EvmLogEpsilonElement : public RANSConstitutiveElement<TDim, TNumNodes, 1>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of EvmLogEpsilonElement
    KRATOS_CLASS_POINTER_DEFINITION(EvmLogEpsilonElement);
     ...
     * Constructor.
     */
    EvmLogEpsilonElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmLogEpsilonElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmLogEpsilonElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmLogEpsilonElement(IndexType NewId,
     ...
     * Copy Constructor
     */
    EvmLogEpsilonElement(EvmLogEpsilonElement const& rOther);

    /**
     * Destructor
     */
    ~EvmLogEpsilonElement() override;
    ...
    /// Assignment operator.
    EvmLogEpsilonElement& operator=(EvmLogEpsilonElement const& rOther);
...
private:
    ...
    array_1d<double, 3> GetConvectiveVelocity(const double turbulent_energy_generation_rate_sigma,
                                              const Vector& rGaussShapeFunctions,
                                              const Matrix& rGaussShapeDerivatives) const;

    double CalculateSourceTerm(const double c1,
                               const double c2,
                               const double f2,
                               const double gamma,
...
#endif // KRATOS_EVM_LOG_EPSILON_ELEMENT_H_INCLUDED  defined
