...
#if !defined(KRATOS_EVM_SQRT_EPSILON_ELEMENT_H_INCLUDED)
#define KRATOS_EVM_SQRT_EPSILON_ELEMENT_H_INCLUDED
...
class EvmSqrtEpsilonElement : public RANSConstitutiveElement<TDim, TNumNodes, 1>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of EvmSqrtEpsilonElement
    KRATOS_CLASS_POINTER_DEFINITION(EvmSqrtEpsilonElement);
     ...
     * Constructor.
     */
    EvmSqrtEpsilonElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmSqrtEpsilonElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmSqrtEpsilonElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmSqrtEpsilonElement(IndexType NewId,
     ...
     * Copy Constructor
     */
    EvmSqrtEpsilonElement(EvmSqrtEpsilonElement const& rOther);

    /**
     * Destructor
     */
    ~EvmSqrtEpsilonElement() override;
    ...
    /// Assignment operator.
    EvmSqrtEpsilonElement& operator=(EvmSqrtEpsilonElement const& rOther);
...
#endif // KRATOS_EVM_SQRT_EPSILON_ELEMENT_H_INCLUDED  defined
