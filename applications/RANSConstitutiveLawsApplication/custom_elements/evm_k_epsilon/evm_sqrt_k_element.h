...
#if !defined(KRATOS_EVM_SQRT_K_ELEMENT_H_INCLUDED)
#define KRATOS_EVM_SQRT_K_ELEMENT_H_INCLUDED
...
class EvmSqrtKElement : public RANSConstitutiveElement<TDim, TNumNodes, 1>
{
public:
    ///@name Type Definitions
    ///@{
    ...
    /// Pointer definition of EvmSqrtKElement
    KRATOS_CLASS_POINTER_DEFINITION(EvmSqrtKElement);
     ...
     * Constructor.
     */
    EvmSqrtKElement(IndexType NewId = 0);

    /**
     * Constructor using an array of nodes
     */
    EvmSqrtKElement(IndexType NewId, const NodesArrayType& ThisNodes);

    /**
     * Constructor using Geometry
     */
    EvmSqrtKElement(IndexType NewId, GeometryType::Pointer pGeometry);

    /**
     * Constructor using Properties
     */
    EvmSqrtKElement(IndexType NewId,
     ...
     * Copy Constructor
     */
    EvmSqrtKElement(EvmSqrtKElement const& rOther);

    /**
     * Destructor
     */
    ~EvmSqrtKElement() override;
    ...
    /// Assignment operator.
    EvmSqrtKElement& operator=(EvmSqrtKElement const& rOther);
...
#endif // KRATOS_EVM_SQRT_K_ELEMENT_H_INCLUDED  defined
