...
#pragma omp parallel for
    ...
    //         mPreviousAggregatedError = CalculationUtilities::WarnIfNegative<NodeType>(rModelPart, TURBULENT_ENERGY_DISSIPATION_RATE, "EpsilonScheme");
    //     } else
    //     {
    //         const double current_aggregated_error = CalculationUtilities::WarnIfNegative<NodeType>(rModelPart, TURBULENT_ENERGY_DISSIPATION_RATE, "EpsilonScheme");
