...
#if !defined(KRATOS_FRACTIONAL_STEP_CO_STRATEGY )
#define  KRATOS_FRACTIONAL_STEP_CO_STRATEGY
...
template<class TSparseSpace,
         ...
         >
class FractionalStepCoStrategy : public SolvingStrategy<TSparseSpace,TDenseSpace,TLinearSolver> 
{
public:
    ///@name Type Definitions
    ///@{
...
//     typedef PointerVectorSet<TDofType, IndexedObject>                          DofsArrayType;
    ...
    KRATOS_CLASS_POINTER_DEFINITION(FractionalStepCoStrategy);
     ...
     */
    explicit FractionalStepCoStrategy(ModelPart& rModelPart, Parameters ThisParameters)
     ...
     */
    explicit FractionalStepCoStrategy(
    ...
    /** Destructor.
     */
    virtual ~FractionalStepCoStrategy(){}
    ...
    virtual void MoveMesh()
    {
        ...
        KRATOS_INFO_IF("FractionalStepCoStrategy", this->GetEchoLevel() != 0 && GetModelPart().GetCommunicator().MyPID() == 0) <<" MESH MOVED "<<std::endl;
    ...
    {
        return "FractionalStepCoStrategy";
    }
...
private:
    ...
    /** Copy constructor.
     */
    FractionalStepCoStrategy(const FractionalStepCoStrategy& Other);


    ///@}

}; /* Class NewFractionalStepCoStrategy */
...
#endif /* KRATOS_FRACTIONAL_STEP_CO_STRATEGY  defined */
