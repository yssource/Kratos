...
namespace Kratos
{
KRATOS_CREATE_VARIABLE( double, TURBULENT_SQRT_KINETIC_ENERGY )
KRATOS_CREATE_VARIABLE( double, TURBULENT_SQRT_ENERGY_DISSIPATION_RATE )
KRATOS_CREATE_VARIABLE( double, TURBULENT_SQRT_KINETIC_ENERGY_RATE )
KRATOS_CREATE_VARIABLE( double, TURBULENT_SQRT_ENERGY_DISSIPATION_RATE_2 )
KRATOS_CREATE_VARIABLE( double, TURBULENT_LOG_KINETIC_ENERGY )
KRATOS_CREATE_VARIABLE( double, TURBULENT_LOG_ENERGY_DISSIPATION_RATE )
KRATOS_CREATE_VARIABLE( double, TURBULENT_LOG_KINETIC_ENERGY_RATE )
KRATOS_CREATE_VARIABLE( double, TURBULENT_LOG_ENERGY_DISSIPATION_RATE_2 )
...
KRATOS_CREATE_VARIABLE( double, FRICTION_VELOCITY )
...
KRATOS_CREATE_VARIABLE( double, RANS_STABILIZATION_MULTIPLIER )
KRATOS_CREATE_VARIABLE( double, RANS_STABILIZATION_MULTIPLIER_MAX )
