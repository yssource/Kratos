...
namespace Kratos
{
KRATOS_DEFINE_VARIABLE( double, TURBULENT_SQRT_KINETIC_ENERGY )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_SQRT_ENERGY_DISSIPATION_RATE )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_SQRT_KINETIC_ENERGY_RATE )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_SQRT_ENERGY_DISSIPATION_RATE_2 )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_LOG_KINETIC_ENERGY )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_LOG_ENERGY_DISSIPATION_RATE )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_LOG_KINETIC_ENERGY_RATE )
KRATOS_DEFINE_VARIABLE( double, TURBULENT_LOG_ENERGY_DISSIPATION_RATE_2 )
...
KRATOS_DEFINE_VARIABLE( double, RESIDUAL )
...
KRATOS_DEFINE_VARIABLE( double, RANS_STABILIZATION_MULTIPLIER )
KRATOS_DEFINE_VARIABLE( double, RANS_STABILIZATION_MULTIPLIER_MAX )
