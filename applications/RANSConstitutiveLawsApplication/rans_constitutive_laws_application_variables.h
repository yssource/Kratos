...
KRATOS_DEFINE_VARIABLE( double, TURBULENT_VISCOSITY_FRACTION )
...
KRATOS_DEFINE_VARIABLE( ElementDerivativesExtension::Pointer, ELEMENT_DERIVATIVES_DOFS_EXTENSION)
}
