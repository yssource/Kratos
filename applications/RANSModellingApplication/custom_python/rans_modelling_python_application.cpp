...
PYBIND11_MODULE(KratosRANSModellingApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_ADJOINT_SCALAR_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_ADJOINT_SCALAR_2)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_ADJOINT_SCALAR_RATE_1)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RANS_ADJOINT_SCALAR_RATE_2)
}
