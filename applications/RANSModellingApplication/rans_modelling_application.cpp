...
void KratosRANSModellingApplication::Register()
{
    ...
    KRATOS_REGISTER_VARIABLE(RANS_Y_PLUS_SENSITIVITIES)
    KRATOS_REGISTER_VARIABLE(RANS_VELOCITY_PARTIAL_DERIVATIVE)
    ...
    KRATOS_REGISTER_VARIABLE(RANS_ADJOINT_SCALAR_1)
    KRATOS_REGISTER_VARIABLE(RANS_ADJOINT_SCALAR_2)
