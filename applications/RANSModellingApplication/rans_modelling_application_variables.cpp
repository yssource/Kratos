...
// Adjoint variables
KRATOS_CREATE_VARIABLE( Matrix, RANS_Y_PLUS_SENSITIVITIES )
KRATOS_CREATE_VARIABLE( Matrix, RANS_VELOCITY_PARTIAL_DERIVATIVE )
...
KRATOS_CREATE_VARIABLE( double, RANS_ADJOINT_SCALAR_1 )
KRATOS_CREATE_VARIABLE( double, RANS_ADJOINT_SCALAR_2 )
