    ...
    PropertiesType::Pointer pProperties) const
{
    ...
    KRATOS_TRY
    return Kratos::make_shared<CustomTestCondition>(NewId, GetGeometry().Create(ThisNodes), pProperties);
    KRATOS_CATCH("");
}
    ...
    PropertiesType::Pointer pProperties) const
{
    ...
    KRATOS_TRY
    return Kratos::make_shared<CustomTestCondition>(NewId, pGeom, pProperties);
    KRATOS_CATCH("");
}
...
{
    KRATOS_TRY
    return Kratos::make_shared<CustomTestCondition>(NewId, GetGeometry().Create(ThisNodes), pGetProperties());
    KRATOS_CATCH("");
}
