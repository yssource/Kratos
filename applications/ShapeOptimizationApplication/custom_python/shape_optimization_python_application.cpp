...
namespace Python
{
  ...
  BOOST_PYTHON_MODULE(KratosShapeOptimizationApplication)
  {
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(CAD_RECONSTRUCTION_ID);
	  KRATOS_REGISTER_IN_PYTHON_VARIABLE(PATCH_ID);
	  KRATOS_REGISTER_IN_PYTHON_VARIABLE(IS_PROJECTED_CAD_POINT_INSIDE_VISIBLE_PATCH_REGION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_BY_PROJECTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_PROJECTED_CAD_POINT_AFTER_RECONSTRUCTION);
    KRATOS_REGISTER_IN_PYTHON_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_NEAREST_CAD_POINT_AFTER_RECONSTRUCTION);    
