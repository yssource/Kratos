...
from .value_logger_steepest_descent_with_projection import ValueLoggerSteepestDescentWithProjection
...
class DataLogger():
    ...
    def __CreateValueLogger( self ):
        ...
        if AlgorithmName == "steepest_descent_with_projection":
            return ValueLoggerSteepestDescentWithProjection( self.Communicator, self.OptimizationSettings )
