...
namespace Kratos
{
	...
	KRATOS_CREATE_VARIABLE( int, PATCH_ID);
	KRATOS_CREATE_VARIABLE( bool, IS_PROJECTED_CAD_POINT_INSIDE_VISIBLE_PATCH_REGION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_BY_PROJECTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_PROJECTED_CAD_POINT_AFTER_RECONSTRUCTION);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_NEAREST_CAD_POINT_AFTER_RECONSTRUCTION);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_VARIABLE( PATCH_ID);
        KRATOS_REGISTER_VARIABLE( IS_PROJECTED_CAD_POINT_INSIDE_VISIBLE_PATCH_REGION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_BY_PROJECTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_PROJECTED_CAD_POINT_AFTER_RECONSTRUCTION);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_NEAREST_CAD_POINT_AFTER_RECONSTRUCTION);        
