...
namespace Kratos
{
    ...
    // FITTING error
    KRATOS_CREATE_VARIABLE(double,SHAPE_CHANGE_ABSOLUTE);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(GRAD_SHAPE_CHANGE);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(FITTING_ERROR);
