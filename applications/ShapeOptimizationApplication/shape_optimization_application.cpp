...
namespace Kratos
{
    ...
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT_MAPPED);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT);
    KRATOS_CREATE_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT_MAPPED);
    ...
    {}
 	...
 	void KratosShapeOptimizationApplication::Register()
 	{
        ...
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CFD_GRADIENT_MAPPED);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT);
        KRATOS_REGISTER_3D_VARIABLE_WITH_COMPONENTS(CSM_GRADIENT_MAPPED);
