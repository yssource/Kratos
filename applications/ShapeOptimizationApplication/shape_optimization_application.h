...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(double,SHAPE_CHANGE_ABSOLUTE);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(GRAD_SHAPE_CHANGE);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(FITTING_ERROR);
