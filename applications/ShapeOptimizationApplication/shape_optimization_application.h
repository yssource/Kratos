...
namespace Kratos
{
	...
	KRATOS_DEFINE_VARIABLE( int, PATCH_ID);
	KRATOS_DEFINE_VARIABLE( bool, IS_PROJECTED_CAD_POINT_INSIDE_VISIBLE_PATCH_REGION);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_BY_PROJECTION);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_PROJECTED_CAD_POINT_AFTER_RECONSTRUCTION);
	KRATOS_DEFINE_3D_VARIABLE_WITH_COMPONENTS(DISTANCE_TO_NEAREST_CAD_POINT_AFTER_RECONSTRUCTION);   	
