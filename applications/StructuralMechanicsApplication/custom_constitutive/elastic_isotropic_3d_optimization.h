...
#if !defined (KRATOS_ELASTIC_ISOTROPIC_OPTIMIZATION_3D_LAW_H_INCLUDED)
#define  KRATOS_ELASTIC_ISOTROPIC_OPTIMIZATION_3D_LAW_H_INCLUDED
...
/**
 * @class ElasticIsotropicOptimization3D
...
public:
   ...
   // typedef ConstitutiveLaw         BaseType;
    ...
    /// Counted pointer of ElasticIsotropicOptimization3D
    KRATOS_CLASS_POINTER_DEFINITION( ElasticIsotropicOptimization3D );
     ...
     */
    ElasticIsotropicOptimization3D();
     ...
     * Copy constructor.
     */
    ElasticIsotropicOptimization3D (const ElasticIsotropicOptimization3D& rOther);

    /**
     * @brief Destructor.
     */
    ~ElasticIsotropicOptimization3D() override;
...
#endif // KRATOS_ELASTIC_ISOTROPIC_OPTIMIZATION_3D_LAW_H_INCLUDED  defined
