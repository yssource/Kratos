...
#if !defined (KRATOS_LINEAR_PLANE_STRAIN_OPTIMIZATION_LAW_H_INCLUDED)
#define  KRATOS_LINEAR_PLANE_STRAIN_OPTIMIZATION_LAW_H_INCLUDED
...
/**
 * @class LinearPlaneStrainOptimization
 ...
 * 
 **/
class KRATOS_API(STRUCTURAL_MECHANICS_APPLICATION) LinearPlaneStrainOptimization 
...
public:
    ...
    /// Counted pointer of LinearPlaneStrainOptimization
    KRATOS_CLASS_POINTER_DEFINITION( LinearPlaneStrainOptimization );
     ...
     * Copy constructor.
     */
    LinearPlaneStrainOptimization (const LinearPlaneStrainOptimization& rOther);


    /**
     * @brief Destructor.
     */
    ~LinearPlaneStrainOptimization() override;
...
#endif // KRATOS_LINEAR_PLANE_STRAIN_OPTIMIZATION_LAW_H_INCLUDED  defined
