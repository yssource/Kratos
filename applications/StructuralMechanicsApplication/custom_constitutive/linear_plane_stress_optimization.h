...
#if !defined (KRATOS_LINEAR_PLANE_STRESS_OPTIMIZATION_LAW_H_INCLUDED)
#define  KRATOS_LINEAR_PLANE_STRESS_OPTIMIZATION_LAW_H_INCLUDED
...
///@{
/**
 * @class LinearPlaneStressOptimization
...
public:
    ...
    /// Counted pointer of LinearPlaneStressOptimization
    KRATOS_CLASS_POINTER_DEFINITION( LinearPlaneStressOptimization );
     ...
     * Copy constructor.
     */
    LinearPlaneStressOptimization (const LinearPlaneStressOptimization& rOther);


    /**
     * Destructor.
     */
    ~LinearPlaneStressOptimization() override;
...
#endif // KRATOS_LINEAR_PLANE_STRESS_OPTIMIZATION_LAW_H_INCLUDED  defined
