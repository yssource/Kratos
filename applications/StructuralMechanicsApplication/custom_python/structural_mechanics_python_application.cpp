...
PYBIND11_MODULE(KratosStructuralMechanicsApplication,m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, AUSTENITIC_YOUNG_MODULUS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MARTENSITIC_YOUNG_MODULUS);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_START_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_END_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_START_BACKWARDS_TRANSFORMATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_END_BACKWARDS_TRANSFORMATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, YIELD_STRESS_COMPRESSION_START_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TEMPERATURE_STRESS_COEFFICIENT);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TEMPERATURE_STRESS_COEFFICIENT_UNLOADING);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REFERENCE_TEMPERATURE);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAXIMUN_RESIDUAL_STRAIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MAXIMUN_RESIDUAL_STRAIN_COMPRESSION);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TRANSFORMATION_STRAIN);
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MARTENSITE_PERCENTAGE);
}
