...
class ImplicitMechanicalSolver(structural_mechanics_solver.MechanicalSolver):
    ...
    def _create_solution_scheme(self):
        ...
        if(scheme_type == "newmark"):
            ...
            mechanical_scheme = KratosMultiphysics.ResidualBasedBossakDisplacementScheme(damp_factor_m)
        elif(scheme_type == "generalized_alpha"):
            damp_factor_m = self.dynamic_settings["damp_factor_m"].GetDouble()
            damp_factor_f = self.dynamic_settings["damp_factor_f"].GetDouble()
            mechanical_scheme = KratosMultiphysics.ResidualBasedGeneralizedAlphaCustomScheme(damp_factor_m, damp_factor_f)
            ...
            err_msg += "Available options are: \"newmark\", \"bossak\", \"generalized_alpha\", \"backward_euler\", \"bdf1\", \"bdf2\", \"bdf3\", \"bdf4\", \"bdf5\", \"relaxation\""
