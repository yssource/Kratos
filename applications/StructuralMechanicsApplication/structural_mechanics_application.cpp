...
void KratosStructuralMechanicsApplication::Register() {
    ...
    // Nitinol CL variables
    KRATOS_REGISTER_VARIABLE(AUSTENITIC_YOUNG_MODULUS);
    KRATOS_REGISTER_VARIABLE(MARTENSITIC_YOUNG_MODULUS);
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_START_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_END_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_START_BACKWARDS_TRANSFORMATION);
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_END_BACKWARDS_TRANSFORMATION);
    KRATOS_REGISTER_VARIABLE(YIELD_STRESS_COMPRESSION_START_FORWARD_TRANSFORMATION);
    KRATOS_REGISTER_VARIABLE(TEMPERATURE_STRESS_COEFFICIENT);
    KRATOS_REGISTER_VARIABLE(TEMPERATURE_STRESS_COEFFICIENT_UNLOADING);
    KRATOS_REGISTER_VARIABLE(REFERENCE_TEMPERATURE);
    KRATOS_REGISTER_VARIABLE(MAXIMUN_RESIDUAL_STRAIN);
    KRATOS_REGISTER_VARIABLE(MAXIMUN_RESIDUAL_STRAIN_COMPRESSION);
    KRATOS_REGISTER_VARIABLE(TRANSFORMATION_STRAIN);
    KRATOS_REGISTER_VARIABLE(MARTENSITE_PERCENTAGE);
