...
KRATOS_CREATE_VARIABLE(double, AUSTENITIC_YOUNG_MODULUS);
KRATOS_CREATE_VARIABLE(double, MARTENSITIC_YOUNG_MODULUS);
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_START_FORWARD_TRANSFORMATION);
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_END_FORWARD_TRANSFORMATION);
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_START_BACKWARDS_TRANSFORMATION);
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_END_BACKWARDS_TRANSFORMATION);
KRATOS_CREATE_VARIABLE(double, YIELD_STRESS_COMPRESSION_START_FORWARD_TRANSFORMATION);
KRATOS_CREATE_VARIABLE(double, TEMPERATURE_STRESS_COEFFICIENT);
KRATOS_CREATE_VARIABLE(double, TEMPERATURE_STRESS_COEFFICIENT_UNLOADING);
KRATOS_CREATE_VARIABLE(double, REFERENCE_TEMPERATURE);
KRATOS_CREATE_VARIABLE(double, MAXIMUN_RESIDUAL_STRAIN);
KRATOS_CREATE_VARIABLE(double, MAXIMUN_RESIDUAL_STRAIN_COMPRESSION);
KRATOS_CREATE_VARIABLE(Vector, TRANSFORMATION_STRAIN);
KRATOS_CREATE_VARIABLE(double, MARTENSITE_PERCENTAGE);
}
