...
KratosSwimmingDEMApplication::KratosSwimmingDEMApplication():
  ...
  mQSVMSDEMCoupled2D(0, Element::GeometryType::Pointer(new Triangle2D3<Node<3> >(Element::GeometryType::PointsArrayType(3)))),
  mQSVMSDEMCoupled3D(0, Element::GeometryType::Pointer(new Tetrahedra3D4<Node<3> >(Element::GeometryType::PointsArrayType(4)))),
...
void KratosSwimmingDEMApplication::Register()
{
  ...
  KRATOS_REGISTER_ELEMENT("QSVMSDEMCoupled2D", mQSVMSDEMCoupled2D)
  KRATOS_REGISTER_ELEMENT("QSVMSDEMCoupled3D", mQSVMSDEMCoupled3D)
