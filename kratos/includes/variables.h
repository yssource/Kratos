...
namespace Kratos
{
    ...
    //KRATOS_DEFINE_VARIABLE(double, ADJOINT_POTENTIAL )
    KRATOS_DEFINE_VARIABLE(double, ADJOINT_POSITIVE_FACE_PRESSURE )
    KRATOS_DEFINE_VARIABLE(double, ADJOINT_NEGATIVE_FACE_PRESSURE )
