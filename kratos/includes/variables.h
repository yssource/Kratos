...
namespace Kratos
{
    ...
    KRATOS_DEFINE_VARIABLE(Matrix, MATRIX_VELOCITY_GRADIENT_TENSOR)
    KRATOS_DEFINE_VARIABLE(Matrix, MATRIX_VELOCITY_DIDACTIC_PRODUCT)
    KRATOS_DEFINE_VARIABLE(Vector, VECTOR_PRESSURE_GRADIENT)
    KRATOS_DEFINE_VARIABLE(double, TURBULENT_KINEMATIC_VISCOSITY)
    KRATOS_DEFINE_VARIABLE(Vector, REYNOLDS_STRESS_MODEL_COEFFICIENTS)
