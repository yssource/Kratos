...
//     AddLegacyStructuralAppVarsToPython();
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MATRIX_VELOCITY_GRADIENT_TENSOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MATRIX_VELOCITY_DIDACTIC_PRODUCT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, VECTOR_PRESSURE_GRADIENT)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, TURBULENT_KINEMATIC_VISCOSITY)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, REYNOLDS_STRESS_MODEL_COEFFICIENTS)
