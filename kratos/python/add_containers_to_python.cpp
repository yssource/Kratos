...
void  AddContainersToPython()
{
    ...
    KRATOS_REGISTER_IN_PYTHON_FLAG(KUTTA);
    ...
    //KRATOS_REGISTER_IN_PYTHON_VARIABLE( ADJOINT_POTENTIAL )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( ADJOINT_POSITIVE_FACE_PRESSURE )
    KRATOS_REGISTER_IN_PYTHON_VARIABLE( ADJOINT_NEGATIVE_FACE_PRESSURE )
