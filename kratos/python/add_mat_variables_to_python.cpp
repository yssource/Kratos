...
namespace Kratos
{
  ...
  namespace Python
  {
    ...
    //registering variables in python
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, IMPLEX )
      ...
      KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, INITIAL_BONDING )
			KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEGRADATION_THRESHOLD )
			KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEGRADATION_RATE_COMPRESSION )
			KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DEGRADATION_RATE_SHEAR )
			KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ALPHA_TENSILE )
			KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, PLASTIC_DEVIATORIC_STRAIN_HARDENING )
