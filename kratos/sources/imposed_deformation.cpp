	...
	)
{
    ...
    case StressMeasure_PK1:
        CalculateMaterialResponsePK1(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_PK2:
        CalculateMaterialResponsePK2(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Kirchhoff:
        CalculateMaterialResponseKirchhoff(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Cauchy:
        CalculateMaterialResponseCauchy(pConstitutiveLaw, rValues);
        break;
	...
	)
{
    ...
    {
    case StressMeasure_PK1:
        InitializeMaterialResponsePK1(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_PK2:
        InitializeMaterialResponsePK2(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Kirchhoff:
        InitializeMaterialResponseKirchhoff(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Cauchy:
        InitializeMaterialResponseCauchy(pConstitutiveLaw, rValues);
        break;
	...
	)
{
    ...
    {
    case StressMeasure_PK1:
        FinalizeMaterialResponsePK1(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_PK2:
        FinalizeMaterialResponsePK2(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Kirchhoff:
        FinalizeMaterialResponseKirchhoff(pConstitutiveLaw, rValues);
        break;

    case StressMeasure_Cauchy:
        FinalizeMaterialResponseCauchy(pConstitutiveLaw, rValues);
        break;
