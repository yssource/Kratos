...
namespace Kratos
{
  ...
  //KRATOS_CREATE_VARIABLE(double, ADJOINT_POTENTIAL )
  KRATOS_CREATE_VARIABLE(double, ADJOINT_POSITIVE_FACE_PRESSURE )
  KRATOS_CREATE_VARIABLE(double, ADJOINT_NEGATIVE_FACE_PRESSURE )
...
//   KRATOS_CREATE_VARIABLE( double, MOULD_AVERAGE_TEMPERATURE )
  ...
  void KratosApplication::RegisterVariables()
  {
      ...
      //KRATOS_REGISTER_VARIABLE( ADJOINT_POTENTIAL )
      KRATOS_REGISTER_VARIABLE( ADJOINT_POSITIVE_FACE_PRESSURE )
      KRATOS_REGISTER_VARIABLE( ADJOINT_NEGATIVE_FACE_PRESSURE )
