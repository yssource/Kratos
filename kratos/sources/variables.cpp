...
KRATOS_CREATE_VARIABLE(double, TURBULENT_KINEMATIC_VISCOSITY)
KRATOS_CREATE_VARIABLE(double, TURBULENT_KINETIC_ENERGY)
KRATOS_CREATE_VARIABLE(Vector, REYNOLDS_STRESS_MODEL_COEFFICIENTS)
...
void KratosApplication::RegisterVariables() {
    ...
    KRATOS_REGISTER_VARIABLE(REYNOLDS_STRESS_MODEL_COEFFICIENTS)
