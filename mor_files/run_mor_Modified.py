...
def _apply_material_properties(mp,num,alpha,beta):
    ...
    mp.GetProperties()[num].SetValue(StructuralMechanicsApplication.RAYLEIGH_ALPHA,alpha)
    mp.GetProperties()[num].SetValue(StructuralMechanicsApplication.RAYLEIGH_BETA,beta)
...
def run_analysis():
    ...
    _add_variables(mp)
    _apply_material_properties(mp,0,alpha,beta)
